...
export const ha: Dict = {
  ...
  directory: {
    ...
    tileTotal: 'L1 a cikin jerin',
    tileRunning: 'An auna, suna aiki',
    tileAttention: 'Suna buƙatar kulawa',
    tileRevoked: 'An soke',
    sweepProgress: 'An auna {done} daga {total}',
    measuringDesc: 'Yana jira a auna shi.',
    howToToggle: 'Yadda ake karanta wannan jerin',
    searchLabel: 'Bincika',
    searchPlaceholder: 'Suna, Chain ID, mai shi ko blockchain ID',
    filterStatus: 'Matsayi',
    filterAll: 'Duka',
    filterRunning: 'Suna aiki',
    filterAttention: 'Suna buƙatar kulawa',
    filterRevoked: 'An soke',
    filterType: "Nau'i",
    filterTypeAll: "Dukkan nau'ikan",
    groupBy: 'Haɗa bisa',
    groupNone: 'Ba haɗawa',
    groupOwner: 'Mai shi',
    groupType: "Nau'i",
    groupStatus: 'Matsayi',
    groupNoType: "Ba a rubuta nau'i ba",
    groupCount: '{shown} daga {total}',
    sortBy: 'Tsara',
    sortNewest: 'Sababbi da farko',
    sortOldest: 'Tsofaffi da farko',
    sortName: 'Suna',
    sortChainId: 'Chain ID',
    sortBlocks: 'Mafi yawan blocks',
    refresh: 'Sake aunawa',
    listCaption: 'Sarƙoƙi a kan A1, tare da matsayin da aka auna na kowanne',
    showing: 'Ana nuna {shown} daga {total}',
    showMore: 'Nuna ƙarin {count}',
    noMatchTitle: 'Babu sarƙar da ta dace',
    noMatchDesc: 'Gwada wata kalma, ko share tacewa.',
    clearFilters: 'Share tacewa',
    showDetails: 'Bayani',
    hideDetails: 'Ɓoye',
    detailsOf: 'Bayanin {name}',
    nativeToken: 'Tokin na asali',
  ...
  validators: {
    title: "Gudanar da mai tabbatarwa",
    desc: "Jimlar da ke shafinmu na farko — tara daga cikin masu tabbatarwa suna aiki a kan na'ura ɗaya, wurin mai bayarwa ɗaya — ita ce raunin gaskiya na wannan hanyar sadarwa, kuma wani daga waje mai na'ura da ba a amfani da ita shi ne kaɗai abin da zai gyara ta. Wannan shafi ya faɗi abin da hakan ke ci, da abin da ba ya biya.",
    liveTitle: "Rukunin masu tabbatarwa yanzu",
    liveTotal: "Masu tabbatarwa",
    liveConnected: "A haɗe",
    liveMinBond: "Mafi ƙarancin jingina",
    liveAtMinimum: "A kan mafi ƙaranci",
    measuredNote: "An karanta daga hanyar sadarwa lokacin da aka buɗe wannan shafi, ba a rubuta da hannu ba. Mafi ƙarancin jingina yana cikin fayil ɗin kulli — ya kasance 25,000 har zuwa 'yan sa'o'i kafin a ƙirƙiri wannan hanyar sadarwa, don haka shafin da ya kwafo shi daga ƙwaƙwalwa yana da nisan sake gina guda ɗaya daga faɗin ƙarya game da kuɗi.",
    costTitle: "Abin da yake ci",
    costMachine: "Na'ura da ke ci gaba da aiki, da adireshin jama'a wanda ake iya isa tashar 9651 daga waje. Babu neman izini, babu jerin izini, babu ƙofar izini a matakin ka'ida — ba a ba wa kowa matsayin mai gudanarwa a lokacin ƙirƙira ba, don haka duk asusun da ke da kuɗi zai iya shiga.",
    costBond: "Jinginar kanka, kulle a duk tsawon wa'adin da ka zaɓa: mafi ƙaranci sa'o'i 24, mafi tsawo kwanaki 365.",
    faucetTitle: "Daga ina LOVE9 ke zuwa, da tarkon da ke cikin lissafin",
    faucetDesc: "Faucet ɗin shi ne dukan hanyar samun kuɗi — babu abin nema, babu wanda za a tambaya. Amma buƙatu tara sun yi daidai da jinginar, kuma daidai da jinginar BAI isa ba: ma'amalolin da ke ɗaukar kuɗinka daga C-Chain zuwa X-Chain sannan zuwa P-Chain, da wanda ke aika jinginar, duk suna biyan kuɗi daga wannan asusun guda. Ka yi shirin buƙatu goma da jiran kusan sa'a guda don iyakar kowace IP ta buɗe. Muna faɗin haka a nan ba a ƙarshe ba, saboda tsohon salon jagorarmu ya rubuta \"tara ya isa\" sannan ya gyara kansa layuka ɗari uku daga baya.",
    getTitle: "Abin da za ka samu",
    getRewards: "Ladan yana buƙatar kashi 80% na lokacin aiki a duk wa'adinka — da gangan ya fi na babbar hanyar sadarwa ta Avalanche sauƙi, domin na'urorin al'umma ba na cibiyar bayanai ba ne.",
    getEnd: "Wa'adinka yana ƙarewa kuma babu abin da ke sabuntawa da kansa. Jinginar tana dawowa idan wa'adin ya cika; karanta lokacin ƙarewarka daga sarƙar maimakon ka lissafa a takarda.",
    getPrivacy: "Babu abin da ya tilasta maka buɗe RPC, kuma mun fi so kada ka buɗe tashar 9650 ko kaɗan. Kullinka naka ne.",
    honestTitle: "Abin da wannan ba ya biya",
    honest1: "LOVE9 alama ce ta gwaji. Ba ta da daraja a nan ko a wani wuri, babu wanda ke siyan ta, kuma babu alkawari cewa daga baya za ta zama wani abu.",
    honest2: "A1 hanyar gwaji ce kuma an riga an sake gina ta daga tubali 0 sau biyu. Idan hakan ya sake faruwa, jinginarka, ladanka da asalin kullinka za su tafi tare da ita. Abin da muka yi alkawari shi ne mu faɗa tun da wuri kuma mu faɗi a fili abin da ake rasawa — alkawarin nan ne kawai.",
    honest3: "A bayan na'urar sadarwa ta gida, kulli yana tashi kuma yana tabbatarwa ta hanyar haɗin da shi kansa ya buɗe, yana kama da lafiya sosai alhali babu wanda daga waje zai iya isa gare shi. Haka mai tabbatarwa na farko daga waje ya kammala cikakken wa'adi da kashi 14% na lokacin aiki bai sami komai ba. Ka tura tashar 9651, kuma ka sanya adireshin jama'a ya zama wanda wannan turawa ke amsawa a kansa.",
    stepsTitle: "Hanyar, a matakai shida",
    step1: "Ɗauki tushen ka sake gina reshen, sannan ka duba hash ɗin bishiyar da kanka — kuma ka duba cewa shigarwar da aka ɓata da gangan tana faɗuwa, don duban farko ya sami ma'ana.",
    step2: "Gina hoton kulli, kana buga commit ɗin da ka gina daga gare shi a ciki.",
    step3: "Sami genesis da adireshin farawa, kuma ka tabbatar da hash ɗin genesis kafin ka gudanar da komai.",
    step4: "Gudanar da kulli. Asalinsa fayiloli uku ne a faifai: rasa su yana nufin jinginarka ta wani kulli ce da ba ya nan.",
    step5: "Tabbatar kana kan sarƙar da ta dace ta hanyar sake karanta sunan hanyar sadarwa da chain ID, ba ta hanyar dogara ga lambar 200 ba.",
    step6: "Kai LOVE9 zuwa P-Chain, sannan ka yi jingina — kuma ka tabbatar da sakamakon a kan sarƙar, ba a cikin abin da kayan aikin ya buga ba.",
    guideCta: "Cikakken jagora, kowane umarni",
  ...
  nineYears: {
    title: "Shekaru tara, biliyan tara",
    lede: "A ranar 2026-09-09 ana rubuta jimloli biyu a cikin tubali na farko na 9Chain, sannan shekaru tara su fara ƙirgawa. Zuwa 2035, Majalisar Ɗinkin Duniya na sa ran Duniya za ta kai kusan mutum biliyan tara. Manufar waɗannan shekaru tara ita ce kowannensu ya mallaki nasa sarƙar bulo.",
    oneLine: "Dole AI dina ta nemi izini — kuma akwai wuri da yake rubuta cewa ta nema. Wannan wurin nawa ne.",
    whatTitle: "Abin da ke faruwa",
    what1: "Fiye da mutum biliyan ɗaya ke amfani da AI kowane mako. Yau AI tana amsa. Gobe za ta yi aiki: ta yi ajiye wuri, ta biya, ta ciniki, ta sa hannu, kuma ta wakilce ka a gaban AI na wani.",
    what2: "Wannan yana haifar da tambaya da ɗan Adam bai taɓa buƙatar amsa ba: me aka bar AI dina ta yi, kuma wa ke riƙe da hujjoji? Yau amsar ita ce kamfanin da ya sayar maka da AI. Izini a hannunsu, bayanan a hannunsu, kuma su ne alƙali idan abu ya lalace.",
    what3: "Rubuta “kada ka kashe fiye da dala ashirin” ba iyaka ba ne — ana iya yaudarar AI, a lallashe ta, a sanya mata umarni. Iyaka ta gaskiya tana zaune a wajen AI, a wurin da ba za ta iya canzawa ba, kuma wannan wurin naka ne.",
    promisesTitle: "Alkawari biyar",
    promise1: "Ikon kai — babu wanda, ko da 9Chain, zai iya canza, gogewa ko kulle littafinka. Dokokinsa su ne waɗanda ka sanya.",
    promise2: "Dawwama — rasa waya ba rasa littafi ba ne. Yana rayuwa fiye da kowace na'ura da kowane kamfani.",
    promise3: "Tabbatarwa — ba za ka iya sake rubuta abin da ya wuce a ɓoye ba, kuma kowa zai iya duba hakan. Hujjojinka ba a hannun ɗayan ɓangaren suke ba.",
    promise4: "Ɗaukuwa — canza mai masauki, mai bayarwa ko ƙasa; sunanka da tarihinka suna tafiya tare da kai.",
    promise5: "Haɗin gwiwa — littafinka yana magana da littattafan wasu, da shaguna, da al'ummomi.",
    promiseNot: "Alkawari ɗaya ba mu yi ba: cewa sarƙarka za ta yi aiki har abada. Ba lallai ba ne. Littafinka yana barci lokacin da kake barci, kuma wanda ke buƙatar karantawa yana karanta kwafin da aka ɗaure.",
    constitutionTitle: "Kundin tsarin mulki, ba umarni ba",
    constitutionDesc: "Littafinka yana ɗauke da yarjejeniya mai gudana: wace AI ce za ta iya sa hannu a madadinka, me za ta iya yi, har nawa, har yaushe, kuma yaushe za ta tsaya ta sake tambaya. Ana janyewa da taɓawa ɗaya, ba tare da izinin kowa ba. Kowane aiki yana barin rasit mai sa hannu da lokaci.",
    constitutionStd: "Yarjejeniya maimakon umarni, saboda yarjejeniya ita ce abu ɗaya tilo da AI ba za ta iya wucewa da magana ba. Tana magana da ƙa'idodin da duniya ke nufa tuni, don haka AI na kowane kamfani na iya karanta ta — ba mu ƙirƙiri wata harshe ta kanmu ba domin haka.",
    treeTitle: "Itace, ba hasumiya ba",
    treeDesc: "Littattafai biliyan tara ba sa zama a kan hanyar sadarwa guda. Kowane mataki yana rajistar matakin ƙasa da shi kuma yana ɗaure shi, kuma yana tabbatar da hujjoji maimakon sake gudanar da su — don haka itacen yana girma ta ƙara rassa, ba ta kauri saiwa ba.",
    treeRoot: "Saiwa — ƙarama, mai ɗorewa, mai gundura da gangan. Tana riƙe sunaye da ɗaurewa. 9Chain saiwa ɗaya ce cikin da yawa.",
    treeTrunk: "Kara — yanki ɗaya, ƙasa ɗaya, ƙawancen al'ummomi.",
    treeBranch: "Reshe — kulob, makaranta, kamfani, unguwa; al'ummar kanta ce ke gudanar da shi.",
    treeLeaf: "Ganye — naka. Ganye biliyan tara.",
    stagesTitle: "Shekaru tara, matakai tara",
    stage2027: "Mutane ɗari na farko na gaskiya, a cikin al'umma ɗaya ta gaskiya, tare da AI da ke aiki ƙarƙashin kundin tsari.",
    stage2028: "Al'ummomi goma suna gudanar da sarƙoƙinsu da kansu a nahiyoyi uku. Littattafai suna tsira daga wayoyin da suka ɓace.",
    stage2029: "Ƙa'ida a buɗe, da aiwatarwa uku waɗanda ba namu ba.",
    stage2030: "Hanyar sadarwa ta farko da ke gudanar da wannan ƙa'ida amma 9Chain ba ta gudanar da ita ba. Littattafai miliyan ɗaya.",
    stage2031: "AI mai aiki ta zama al'ada — kuma AI marar saiwar iko ta fara samun ƙi.",
    stage2032: "Saiwoyi da yawa, ƙa'ida ɗaya. Shugabancin ƙa'idar ya bar 9Chain.",
    stage2033: "Littattafai suna tafiya cikin walat ɗin shaida, wayoyi, manhajojin saƙo, da dandalin AI.",
    stage2034: "Wayoyi na fita daga masana'anta da littafi. Biliyan ɗaya cikin amfani na gaske.",
    stage2035: "Sarƙa ɗaya ga kowane mutum. Shekaru tara tun tubali na farko.",
    stagesNote: "Shekaru huɗu na ginawa da tabbatarwa; a shekara ta biyar duniya ta mai da shi wajibi; shekaru huɗu da wasu za su kai shi gaba fiye da yadda za mu iya. Wannan ɓangare na ƙarshe shiri ne, ba haɗari ba.",
    commitTitle: "Abin da muka yi alkawarin ba za mu yi ba",
    commit1: "Ba ma ajiye bayananka. Littafin yana ajiye hujjoji, ba rayuwarka ta sirri ba.",
    commit2: "Ba ma neman takardunka. Shaidar kai al'amari ne tsakaninka da al'ummarka.",
    commit3: "Ba ma gogewa. Sunaye, littattafai da tarihi na dindindin ne; suna barci, ba sa mutuwa.",
    commit4: "Ba ma tilasta ka sayi alama don ka mallaki littafi. Ƙa'idar a buɗe take; LOVE9 man fetur ne na wannan hanyar sadarwa, ba tikitin shiga ba.",
    commit5: "Ba ma gina AI ta kanmu. Muna zama tsaka-tsaki don kowace AI ta iya yi maka hidima a kan littafi guda.",
    joinTitle: "Shekaru tara na farawa da mutanen farko",
    joinDesc: "Yau wannan hanyar gwaji ce mai gudana, tare da masu tabbatarwa na farko daga waje da sarƙoƙin al'umma na farko. Duk abin da ke ƙasa a buɗe yake, yanzu, ga kowa.",
    fullDoc: "Cikakken takardar",
  },
  ...
  compare: {
    ...
    measuring: 'ana auna…',
    cannotMeasure: 'ba a iya auna ba',
    critDecentralisation: 'Rarraba iko (iyakar adadin masu tabbatarwa)',
    noteDecentralisation: 'Iyakar YARJEJENIYA: Snowman ~dubban kumburi idan aka kwatanta da CometBFT ~150. A1 YAU: kumburi 9, na’ura ɗaya, mai bayarwa ɗaya',
    critFinality: 'Ƙarshen tabbaci',
    noteFinality: 'kimanin daƙiƙa 1–2 idan aka kwatanta da kimanin daƙiƙa 5–6',
    critEvmMaturity: 'Balagar EVM',
    noteEvmMaturity: 'coreth yana aiki a samarwa idan aka kwatanta da Cosmos EVM kafin v1',
    critWalletCompat: 'Daidaituwa da walat da DeFi na yau da kullum',
    noteWalletCompat: 'cikakken MetaMask/EVM',
    critLaunchUx: 'Kwarewar ƙirƙirar sarƙa',
    noteLaunchUx: 'duka biyu suna da na’urar sarrafawa; a A1 an auna kusan daƙiƙa 170 kowanne',
    critInterop: 'Faɗin haɗin kai',
    noteInterop: 'Warp/ICM cikin tsarin (A1 ya riga ya matsar da dukiya, M6.2) idan aka kwatanta da isar IBC',
    critOpCost: 'Kuɗin gudanarwa ga kowace sarƙa',
    noteOpCost: 'kumburi + ƙari idan aka kwatanta da mai sarrafa K8s',
    critBootstrap: 'Fara tasirin hanyar sadarwa',
    noteBootstrap: 'tsibiri na kansa idan aka kwatanta da IBC da ke haɗe da tattalin arzikin Cosmos',
    critEconSecurity: 'Tsaron tattalin arziki a bainar jama’a',
    noteEconSecurity: 'an tabbatar da shi da tokan PoS tun farko',
    critSwitchCost: 'Kuɗin sauyawa ga ƙungiyar',
    noteSwitchCost: 'A1 sabo ne idan aka kwatanta da C1 da ke aiki tsawon watanni',
  },
