...
export const tl: Dict = {
  ...
  validators: {
    title: "Magpatakbo ng validator",
    desc: "Ang pangungusap sa aming home page — siyam sa mga validator ay tumatakbo sa iisang makina, sa iisang provider — ang tapat na kahinaan ng network na ito, at ang taga-labas na may bakanteng makina lang ang makapagwawasto nito. Sinasabi ng pahinang ito kung magkano ang halaga nito, at kung ano ang hindi nito binabayaran.",
    liveTitle: "Ang hanay ngayon",
    liveTotal: "Mga validator",
    liveConnected: "Nakakonekta",
    liveMinBond: "Pinakamababang sariling bond",
    liveAtMinimum: "Nasa pinakamababa",
    measuredNote: "Binasa mula sa network noong na-load ang pahinang ito, hindi tinipa. Ang pinakamababang bond ay naka-compile sa binary ng node — 25,000 iyon hanggang ilang oras bago likhain ang network na ito, kaya ang pahinang sinisipi ito mula sa alaala ay isang muling pagbuo lang ang layo sa pagkakamali tungkol sa pera.",
    costTitle: "Ano ang gastos",
    costMachine: "Isang makinang nananatiling bukas, at isang pampublikong address na maaabot ang port 9651 mula sa labas. Walang aplikasyon, walang listahan ng pinapayagan, walang pintuan ng pahintulot sa antas ng protocol — walang binigyan ng operator role sa genesis, kaya makakasali ang anumang account na may pondo.",
    costBond: "Isang sariling bond, nakakandado sa termino mong pipiliin: pinakamaikli 24 oras, pinakamahaba 365 araw.",
    faucetTitle: "Saan nanggagaling ang LOVE9, at ang bitag sa aritmetika",
    faucetDesc: "Ang faucet ang buong daan ng pondo — walang aaplayan, walang hihingian. Ngunit ang siyam na kahilingan ay eksaktong katumbas ng bond, at ang eksaktong bond ay HINDI sapat: ang mga transaksyong naglilipat ng iyong balanse mula C-Chain patungong X-Chain at saka P-Chain, at ang nagsusumite ng stake, ay parehong kinukuha ang bayad sa iisang balanse. Maglaan ng sampung kahilingan at hanggang isang oras na paghihintay para sa limitasyon kada IP. Sinasabi namin ito rito at hindi sa dulo, dahil sinabi ng lumang bersyon ng sarili naming gabay na \"sapat na ang siyam\" at itinama lang ang sarili tatlong daang linya ang layo.",
    getTitle: "Ano ang makukuha mo",
    getRewards: "Kailangan ng gantimpala ang 80% uptime sa buong termino — sadyang mas maluwag kaysa sa mainnet ng Avalanche, dahil ang hardware ng komunidad ay hindi hardware ng data center.",
    getEnd: "Nagtatapos ang termino mo at walang awtomatikong nire-renew. Bumabalik ang stake kapag nag-expire; basahin ang sarili mong oras ng pagtatapos mula sa chain sa halip na kuwentahin ito.",
    getPrivacy: "Walang pumipilit sa iyong ilantad ang isang RPC, at mas gugustuhin naming hindi mo buksan ang port 9650 kahit kailan. Sa iyo ang node mo.",
    honestTitle: "Ano ang hindi nito binabayaran",
    honest1: "Ang LOVE9 ay test token. Wala itong halaga rito ni saanman, walang bumibili nito, at walang pangakong magiging kung ano ito balang araw.",
    honest2: "Testnet ang A1 at dalawang beses nang muling itinayo mula sa block 0. Kung mangyari uli, kasama nitong mawawala ang stake, gantimpala at pagkakakilanlan ng node mo. Ang ipinapangako namin ay sabihin ito nang maaga at sabihin nang malinaw kung ano ang nawawala — iyon lang ang pangako.",
    honest3: "Sa likod ng router sa bahay, nakaka-bootstrap at nakakapag-validate ang node sa mga koneksyong ito mismo ang nagbukas, at mukhang ganap itong malusog samantalang walang taga-labas na makakaabot dito. Ganoon natapos ng unang panlabas na validator ang isang buong termino sa 14% uptime at walang kinita. I-forward ang port 9651, at itakda ang pampublikong address sa address na sinasagot ng forwarding na iyon.",
    stepsTitle: "Ang daan, sa anim na hakbang",
    step1: "Kunin ang source at muling buuin ang fork, saka mismong ikaw ang magsuri ng tree hash — at suriin ding nabibigo ang sinadyang maling input, para may kahulugan ang unang pagsusuri.",
    step2: "Buuin ang image ng node, na nakatatak ang commit na pinagbuuan mo.",
    step3: "Kunin ang genesis at isang bootstrap address, at patunayan ang genesis hash bago magpatakbo ng kahit ano.",
    step4: "Patakbuhin ang node. Ang pagkakakilanlan nito ay tatlong file sa disk: mawala ang mga ito at ang bond mo ay pag-aari ng isang node na wala na.",
    step5: "Kumpirmahing nasa tamang chain ka sa pamamagitan ng pagbabasa muli sa pangalan ng network at chain ID, hindi sa pagtitiwala sa isang 200.",
    step6: "Ilipat ang LOVE9 sa P-Chain, saka mag-stake — at patunayan ang resulta sa chain, hindi sa output ng tool.",
    guideCta: "Ang buong gabay, bawat utos",
  ...
  nineYears: {
    title: "Siyam na taon, siyam na bilyon",
    lede: "Sa 2026-09-09 dalawang pangungusap ang ilalagay sa unang block ng 9Chain, at magsisimulang bilangin ang siyam na taon. Pagsapit ng 2035, inaasahan ng UN na mangangailangan ng halos siyam na bilyong tao ang Mundo. Layunin ng siyam na taong iyon: bawat isa sa kanila ay may sariling blockchain.",
    oneLine: "Kailangang humingi ng pahintulot ang AI ko — at may lugar na nagtatala na humingi nga ito. Akin ang lugar na iyon.",
    whatTitle: "Ano ang nangyayari",
    what1: "Mahigit isang bilyong tao ang gumagamit ng AI kada linggo. Ngayon, sumasagot ang AI. Bukas, kumikilos ito: nagbu-book, nagbabayad, nakikipagtawaran, pumipirma, at kumakatawan sa iyo sa harap ng AI ng iba.",
    what2: "Nagbubunga ito ng tanong na hindi pa kailanman kinailangang sagutin ng sangkatauhan: ano ang pinapayagang gawin ng AI ko, at sino ang may hawak ng ebidensya? Ngayon, ang sagot ay ang kompanyang nagbenta sa iyo ng AI. Nasa kanila ang mga pahintulot, nasa kanila ang mga tala, at sila rin ang hukom kapag may mali.",
    what3: "Ang sabihing “huwag gumastos nang higit sa dalawampung dolyar” ay hindi hangganan — maaaring lokohin, hikayatin, o paksukan ng utos ang AI. Ang tunay na hangganan ay nasa labas ng AI, sa lugar na hindi nito mababago, at sa iyo ang lugar na iyon.",
    promisesTitle: "Limang pangako",
    promise1: "Soberanya — walang sinuman, kahit ang 9Chain, ang makababago, makabubura, o makakakandado sa iyong talaan. Ang mga patakaran nito ay ang itinakda mo.",
    promise2: "Pananatili — ang mawalan ng telepono ay hindi pagkawala ng talaan. Nabubuhay ito nang mas matagal kaysa sa anumang gadget at anumang kompanya.",
    promise3: "Napapatunayan — hindi mo maaaring baguhin nang tahimik ang nakaraan, at kahit sino ay makatitiyak niyon. Hindi nasa kabilang panig ang ebidensya mo.",
    promise4: "Nadadala — magpalit ka man ng host, provider, o bansa; kasama mong pupunta ang pangalan at kasaysayan mo.",
    promise5: "Nag-uusap — ang talaan mo ay nakikipag-usap sa talaan ng iba, sa mga tindahan, sa mga komunidad.",
    promiseNot: "May isang bagay na hindi namin ipinapangako: na tatakbo nang habambuhay ang chain mo. Hindi naman kailangan. Natutulog ang talaan mo kapag natutulog ka, at ang kailangang bumasa ay babasa sa naka-angkla nang kopya.",
    constitutionTitle: "Isang saligang batas, hindi utos",
    constitutionDesc: "May dalang tumatakbong kasunduan ang talaan mo: aling AI ang puwedeng pumirma para sa iyo, ano ang puwede nitong gawin, hanggang magkano, hanggang kailan, at kailan ito dapat huminto at magtanong muli. Nababawi sa isang pindot, walang paalam kaninuman. Bawat kilos ay nag-iiwan ng resibong may pirma at oras.",
    constitutionStd: "Kasunduan sa halip na bilin, dahil ang kasunduan lang ang hindi kayang lusutan ng AI sa pamamagitan ng salita. Nagsasalita ito sa mga pamantayang pinagtatagpuan na ng mundo, kaya kayang basahin ito ng AI ng kahit sinong kompanya — hindi kami gumawa ng sariling wika para rito.",
    treeTitle: "Isang puno, hindi tore",
    treeDesc: "Hindi kasya sa isang network ang siyam na bilyong talaan. Bawat antas ay nagtatala at nag-aangkla sa antas na nasa ilalim nito, at nagpapatunay ng patunay sa halip na patakbuhin itong muli — kaya lumalaki ang puno sa pagdaragdag ng sanga, hindi sa pagpapalapad ng ugat.",
    treeRoot: "Ugat — maliit, matibay, sadyang nakakainip. Nag-iingat ng mga pangalan at angkla. Isa lamang ang 9Chain sa maraming ugat.",
    treeTrunk: "Puno ng kahoy — isang rehiyon, isang bansa, isang alyansa ng mga komunidad.",
    treeBranch: "Sanga — isang samahan, paaralan, kompanya, purok; pinapatakbo mismo ng komunidad na iyon.",
    treeLeaf: "Dahon — sa iyo. Siyam na bilyong dahon.",
    stagesTitle: "Siyam na taon, siyam na yugto",
    stage2027: "Ang unang isandaang totoong tao, sa isang totoong komunidad, kasama ang AI na kumikilos sa ilalim ng isang saligang batas.",
    stage2028: "Sampung komunidad ang mismong nagpapatakbo ng sariling chain sa tatlong kontinente. Nakakaligtas ang talaan sa nawawalang telepono.",
    stage2029: "Isang bukas na pamantayan, at tatlong pagpapatupad na hindi sa amin.",
    stage2030: "Ang unang network na tumatakbo sa pamantayang ito na hindi pinapatakbo ng 9Chain. Isang milyong talaan.",
    stage2031: "Nagiging karaniwan ang AI na kumikilos — at nagsisimulang tanggihan ang AI na walang ugat ng awtoridad.",
    stage2032: "Maraming ugat, isang pamantayan. Lumalabas sa 9Chain ang pamamahala ng pamantayan.",
    stage2033: "Naglalakbay ang mga talaan sa loob ng identity wallet, telepono, messaging app, at AI platform.",
    stage2034: "May kasamang talaan ang mga teleponong lumalabas sa pabrika. Isang bilyon ang aktibong ginagamit.",
    stage2035: "Isang chain bawat tao. Siyam na taon mula sa unang block.",
    stagesNote: "Apat na taon para magtayo at magpatunay; sa ikalima, ginagawa itong kailangan ng mundo; apat na taon kung saan dinadala ito ng iba nang mas malayo kaysa sa kaya namin. Ang huling bahaging iyon ay plano, hindi panganib.",
    commitTitle: "Ang ipinapangako naming hindi gagawin",
    commit1: "Hindi namin iniingatan ang datos mo. Ebidensya ang laman ng talaan, hindi ang pribado mong buhay.",
    commit2: "Hindi namin hinihingi ang mga papeles mo. Ang pagkakakilanlan ay sa iyo at sa komunidad mo.",
    commit3: "Hindi kami nagbubura. Permanente ang mga pangalan, talaan at kasaysayan; natutulog sila, hindi namamatay.",
    commit4: "Hindi ka namin pinipilit bumili ng token para magkaroon ng talaan. Bukas ang pamantayan; ang LOVE9 ay gasolina ng network na ito, hindi tiket sa pintuan.",
    commit5: "Hindi kami gumagawa ng sariling AI. Nananatili kaming neutral para kahit anong AI ay makapaglingkod sa iyo sa iisang talaan.",
    joinTitle: "Nagsisimula ang siyam na taon sa mga unang tao",
    joinDesc: "Ngayon, ito ay tumatakbong test network, may mga unang panlabas na validator at mga unang chain ng komunidad. Bukas na ngayon sa kahit sino ang lahat ng nasa ibaba.",
    fullDoc: "Ang buong dokumento",
  },
