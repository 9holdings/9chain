...
export const tr: Dict = {
  ...
  nav: {
    ...
    validators: "Bir doğrulayıcı çalıştır",
    docs: "Belgeler",
    nineYears: "Dokuz yıl, dokuz milyar",
  },
  ...
  validators: {
    title: "Bir doğrulayıcı çalıştır",
    desc: "Ana sayfamızdaki cümle — doğrulayıcıların dokuzu tek bir makinede, tek bir sağlayıcıda — bu ağın dürüst zayıflığıdır ve boşta bir makinesi olan dışarıdan biri onu düzeltebilecek tek şeydir. Bu sayfa bunun neye mal olduğunu ve neyi ödemediğini anlatır.",
    liveTitle: "Şu andaki küme",
    liveTotal: "Doğrulayıcı",
    liveConnected: "Bağlı",
    liveMinBond: "Asgari kendi teminatı",
    liveAtMinimum: "Asgari teminatla",
    measuredNote: "Bu sayfa yüklenirken ağdan okundu, elle yazılmadı. Asgari teminat düğüm ikilisine derlenmiştir — bu ağ oluşturulmadan saatler öncesine kadar 25.000'di; dolayısıyla bu sayıyı ezberden aktaran bir sayfa, para konusunda yanılmaya bir yeniden kurulum uzaklıktadır.",
    costTitle: "Neye mal olur",
    costMachine: "Açık kalan bir makine ve dışarıdan 9651 portuna erişilebilen genel bir adres. Başvuru yok, izin listesi yok, protokol düzeyinde izin kapısı yok — operatör rolü doğuşta kimseye verilmedi, bu yüzden bakiyesi olan herhangi bir hesap katılabilir.",
    costBond: "Seçtiğiniz süre boyunca kilitlenen bir kendi teminatınız: en az 24 saat, en çok 365 gün.",
    faucetTitle: "LOVE9 nereden gelir ve aritmetikteki tuzak",
    faucetDesc: "Musluk, finansmanın tamamıdır — başvurulacak bir şey, sorulacak bir kimse yok. Ama dokuz istek tam olarak teminata denk gelir ve tam teminat YETMEZ: bakiyenizi C-Chain'den X-Chain'e, oradan P-Chain'e taşıyan işlemler ile stake'i gönderen işlem, ücretlerini aynı bakiyeden öder. On istek ve IP başına sınırın açılması için bir saate varan bekleme hesaplayın. Bunu sonda değil burada söylüyoruz, çünkü kendi kılavuzumuzun eski bir sürümü \"dokuz yeter\" yazmış ve üç yüz satır sonra kendini düzeltmişti.",
    getTitle: "Ne elde edersiniz",
    getRewards: "Ödüller süreniz boyunca %80 çalışma süresi ister — Avalanche ana ağından bilerek daha gevşek, çünkü topluluk donanımı veri merkezi donanımı değildir.",
    getEnd: "Süreniz biter ve hiçbir şey kendiliğinden yenilenmez. Süre dolduğunda teminat geri gelir; kendi bitiş zamanınızı kâğıt üzerinde hesaplamak yerine zincirden okuyun.",
    getPrivacy: "Hiçbir şey sizi bir RPC açmaya zorlamıyor; 9650 portunu hiç açmamanızı tercih ederiz. Düğümünüz sizindir.",
    honestTitle: "Bunun ödemediği şeyler",
    honest1: "LOVE9 bir test jetonudur. Ne burada ne başka yerde değeri vardır, kimse onu satın almıyor ve ileride bir şeye dönüşeceğine dair bir söz de yok.",
    honest2: "A1 bir test ağıdır ve şimdiden iki kez sıfırıncı bloktan yeniden kuruldu. Bir daha olursa teminatınız, ödülleriniz ve düğüm kimliğiniz onunla birlikte gider. Söz verdiğimiz şey önceden haber vermek ve neyin kaybolduğunu açıkça söylemek — sözün tamamı bu.",
    honest3: "Ev yönlendiricisinin arkasında bir düğüm, kendi açtığı bağlantılar üzerinden önyükleme yapar ve doğrular; dışarıdan kimse ona ulaşamazken tamamen sağlıklı görünür. İlk dış doğrulayıcı böylece bir dönemi %14 çalışma süresiyle bitirdi ve hiçbir şey kazanmadı. 9651 portunu yönlendirin ve genel adresi, o yönlendirmenin yanıt verdiği adres olarak ayarlayın.",
    stepsTitle: "Yol, altı adımda",
    step1: "Kaynağı alın ve çatalı yeniden derleyin, sonra ağaç özetini kendiniz doğrulayın — ve kasıtlı olarak yanlış bir girdinin başarısız olduğunu da doğrulayın ki ilk kontrol bir anlam taşısın.",
    step2: "Düğüm imajını, hangi commit'ten derlediğinizi içine damgalayarak oluşturun.",
    step3: "Genesis'i ve bir önyükleme adresini alın, herhangi bir şey çalıştırmadan önce genesis özetini doğrulayın.",
    step4: "Düğümü çalıştırın. Kimliği diskteki üç dosyadır: onları kaybederseniz teminatınız artık var olmayan bir düğüme aittir.",
    step5: "Ağ adını ve zincir kimliğini geri okuyarak doğru zincirde olduğunuzu doğrulayın; bir 200'e güvenerek değil.",
    step6: "LOVE9'u P-Chain'e taşıyın, sonra stake edin — ve sonucu aracın çıktısında değil zincirde doğrulayın.",
    guideCta: "Tam kılavuz, her komut",
  ...
  nineYears: {
    title: "Dokuz yıl, dokuz milyar",
    lede: "2026-09-09'da iki cümle 9Chain'in ilk bloğuna kazınıyor ve dokuz yıl saymaya başlıyor. 2035'e gelindiğinde BM, Dünya'da dokuz milyara yakın insan bekliyor. Bu dokuz yılın hedefi: her birinin kendine ait bir blok zinciri olması.",
    oneLine: "Yapay zekâm izin istemek zorunda — ve istediğini kaydeden bir yer var. O yer benim.",
    whatTitle: "Ne oluyor",
    what1: "Her hafta bir milyardan fazla insan yapay zekâ kullanıyor. Bugün yapay zekâ yanıtlıyor. Yarın eyleme geçiyor: rezervasyon yapıyor, ödüyor, pazarlık ediyor, imzalıyor ve bir başkasının yapay zekâsı karşısında sizi temsil ediyor.",
    what2: "Bu, insanlığın daha önce yanıtlamak zorunda kalmadığı bir soruyu doğuruyor: yapay zekâmın neye izni var ve kanıtları kim tutuyor? Bugünkü yanıt, size yapay zekâyı satan şirket. İzinler onlarda, kayıtlar onlarda ve iş ters gittiğinde hakem de onlar.",
    what3: "“Yirmi dolardan fazla harcama” demek bir sınır değildir — yapay zekâ kandırılabilir, ikna edilebilir, içine komut sızdırılabilir. Gerçek sınır yapay zekânın dışında, onun değiştiremeyeceği bir yerde yaşar ve o yer size aittir.",
    promisesTitle: "Beş söz",
    promise1: "Egemenlik — kimse, 9Chain bile, defterinizi değiştiremez, silemez, kilitleyemez. Kuralları sizin koyduklarınızdır.",
    promise2: "Kalıcılık — telefonu kaybetmek defteri kaybetmek değildir. Her cihazdan ve her şirketten uzun yaşar.",
    promise3: "Doğrulanabilirlik — geçmişi sessizce yeniden yazamazsınız ve bunu herkes denetleyebilir. Kanıtlarınız karşı tarafta durmaz.",
    promise4: "Taşınabilirlik — barındırmayı, sağlayıcıyı, ülkeyi değiştirin; adınız ve geçmişiniz sizinle gelir.",
    promise5: "Birlikte çalışabilirlik — defteriniz başkalarının defterleriyle, dükkânlarla, topluluklarla konuşur.",
    promiseNot: "Vermediğimiz tek söz: zincirinizin sonsuza dek çalışacağı. Buna gerek yok. Siz uyurken defteriniz de uyur; okuması gereken, çıpalanmış kopyayı okur.",
    constitutionTitle: "Bir anayasa, bir komut değil",
    constitutionDesc: "Defteriniz çalışan bir sözleşme taşır: hangi yapay zekâ sizin adınıza imzalayabilir, ne yapabilir, ne kadara kadar, ne zamana kadar ve nerede durup yeniden sormalıdır. Kimsenin iznine gerek olmadan tek dokunuşla geri alınır. Her eylem imzalı ve zaman damgalı bir makbuz bırakır.",
    constitutionStd: "Talimat değil sözleşme, çünkü sözleşme bir yapay zekânın konuşarak aşamayacağı tek şeydir. Dünyanın zaten yakınsadığı standartları konuşur, böylece herhangi bir şirketin yapay zekâsı onu okuyabilir — bunun için özel bir dil icat etmedik.",
    treeTitle: "Bir ağaç, kule değil",
    treeDesc: "Dokuz milyar defter tek bir ağa sığmaz. Her katman altındakini kaydeder ve çıpalar, kanıtları yeniden çalıştırmak yerine doğrular — böylece ağaç kökü kalınlaştırarak değil, dal ekleyerek büyür.",
    treeRoot: "Kök — küçük, dayanıklı, bilerek sıkıcı. Adları ve çıpaları tutar. 9Chain birçok kökten biridir.",
    treeTrunk: "Gövde — bir bölge, bir ülke, toplulukların bir birliği.",
    treeBranch: "Dal — bir kulüp, bir okul, bir şirket, bir mahalle; o topluluğun kendisi işletir.",
    treeLeaf: "Yaprak — sizinki. Dokuz milyar yaprak.",
    stagesTitle: "Dokuz yıl, dokuz aşama",
    stage2027: "Gerçek bir toplulukta ilk yüz gerçek insan; yapay zekâlar bir anayasa altında çalışıyor.",
    stage2028: "Üç kıtada on topluluk kendi zincirlerini kendisi işletiyor. Defterler kaybolan telefonlardan sağ çıkıyor.",
    stage2029: "Açık bir standart ve bize ait olmayan üç uygulama.",
    stage2030: "Standardı çalıştıran ama 9Chain'in işletmediği ilk ağ. Bir milyon defter.",
    stage2031: "Eyleme geçen yapay zekâ olağan hâle gelir — yetki kökü olmayan yapay zekâ reddedilmeye başlar.",
    stage2032: "Çok kök, tek standart. Standardın yönetişimi 9Chain'den ayrılır.",
    stage2033: "Defterler kimlik cüzdanlarının, telefonların, mesajlaşma uygulamalarının, yapay zekâ platformlarının içinde dolaşır.",
    stage2034: "Telefonlar fabrikadan bir defterle çıkar. Bir milyar defter etkin kullanımda.",
    stage2035: "Kişi başına bir zincir. İlk bloktan bu yana dokuz yıl.",
    stagesNote: "Dört yıl inşa ve kanıt; beşinci yılda dünya bunu zorunlu kılar; son dört yılda başkaları bizim taşıyabileceğimizden daha ileri götürür. Bu son kısım risk değil, planın kendisidir.",
    commitTitle: "Yapmamaya söz verdiklerimiz",
    commit1: "Verilerinizi saklamıyoruz. Defter kanıt tutar, özel hayatınızı değil.",
    commit2: "Belgelerinizi istemiyoruz. Kimlik, sizinle topluluğunuz arasındadır.",
    commit3: "Silmiyoruz. Adlar, defterler ve geçmiş kalıcıdır; uyurlar, ölmezler.",
    commit4: "Defteriniz olsun diye jeton almanızı şart koşmuyoruz. Standart açıktır; LOVE9 bu ağın yakıtıdır, kapıdaki bilet değil.",
    commit5: "Kendi yapay zekâmızı yapmıyoruz. Her yapay zekânın aynı defter üzerinde size hizmet edebilmesi için tarafsız kalıyoruz.",
    joinTitle: "Dokuz yıl ilk insanlarla başlar",
    joinDesc: "Bugün bu, ilk dış doğrulayıcıları ve ilk topluluk zincirleri olan, çalışan bir test ağıdır. Aşağıdaki her şey şu anda herkese açıktır.",
    fullDoc: "Belgenin tamamı",
  },
