...
export const nl: Dict = {
  ...
  nineYears: {
    title: "Negen jaar, negen miljard",
    lede: "Op 2026-09-09 gaan twee zinnen in het eerste blok van 9Chain, en beginnen negen jaar te tellen. Tegen 2035 verwacht de VN bijna negen miljard mensen op aarde. Het doel van die negen jaar: dat ieder van hen een eigen blockchain bezit.",
    oneLine: "Mijn AI moet om toestemming vragen — en er is een plek die vastlegt dát ze het vroeg. Die plek is van mij.",
    whatTitle: "Wat er gebeurt",
    what1: "Meer dan een miljard mensen gebruiken elke week AI. Vandaag antwoordt AI. Morgen handelt ze: boekt, betaalt, onderhandelt, tekent en vertegenwoordigt je tegenover de AI van iemand anders.",
    what2: "Dat roept een vraag op die de mensheid nooit heeft hoeven beantwoorden: wat mag mijn AI, en wie heeft het bewijs? Vandaag is het antwoord: het bedrijf dat je de AI verkoopt. Zij hebben de rechten, zij hebben de logs, en zij zijn de scheidsrechter als het misgaat.",
    what3: "Een opdracht als «geef niet meer uit dan twintig dollar» is geen grens — een AI kan misleid, overtuigd, van instructies voorzien worden. Een echte grens leeft buiten de AI, op een plek die ze niet kan bewerken, en die plek is van jou.",
    promisesTitle: "Vijf beloften",
    promise1: "Soevereiniteit — niemand, ook 9Chain niet, kan je grootboek wijzigen, wissen of vergrendelen. De regels zijn de jouwe.",
    promise2: "Duurzaamheid — je telefoon kwijt is je grootboek niet kwijt. Het overleeft elk apparaat en elk bedrijf.",
    promise3: "Verifieerbaarheid — je kunt het verleden niet stil herschrijven, en iedereen kan dat nagaan. Jouw bewijs ligt niet bij de tegenpartij.",
    promise4: "Overdraagbaarheid — verander van host, aanbieder of land; je naam en geschiedenis gaan mee.",
    promise5: "Samenwerking — je grootboek praat met dat van anderen, met winkels, met gemeenschappen.",
    promiseNot: "Eén belofte doen we niet: dat je chain eeuwig draait. Dat hoeft ook niet. Je grootboek slaapt wanneer jij slaapt, en wie het moet lezen leest de verankerde kopie.",
    constitutionTitle: "Een grondwet, geen opdracht",
    constitutionDesc: "Je grootboek draagt een draaiend contract: welke AI namens jou mag tekenen, wat ze mag, tot welk bedrag, tot wanneer, en wanneer ze moet stoppen en opnieuw vragen. Met één tik in te trekken, zonder iemands toestemming. Elke handeling laat een ondertekend bonnetje met tijdstempel achter.",
    constitutionStd: "Een contract in plaats van een aanwijzing, omdat een contract het enige is waar een AI zich niet uit praat. Het spreekt de standaarden waar de wereld toch al naartoe beweegt, dus de AI van elk bedrijf kan het lezen — we hebben er geen eigen taal voor bedacht.",
    treeTitle: "Een boom, geen toren",
    treeDesc: "Negen miljard grootboeken passen niet op één netwerk. Elke laag registreert en verankert de laag eronder en verifieert bewijzen in plaats van ze opnieuw uit te voeren — zo groeit de boom door takken toe te voegen, niet door de wortel dikker te maken.",
    treeRoot: "Wortel — klein, duurzaam, bewust saai. Bewaart namen en ankers. 9Chain is één wortel tussen vele.",
    treeTrunk: "Stam — een regio, een land, een verbond van gemeenschappen.",
    treeBranch: "Tak — een club, een school, een bedrijf, een buurt, gerund door die gemeenschap zelf.",
    treeLeaf: "Blad — het jouwe. Negen miljard bladeren.",
    stagesTitle: "Negen jaar, negen fasen",
    stage2027: "De eerste honderd echte mensen, in één echte gemeenschap, met AI die onder een grondwet werkt.",
    stage2028: "Tien gemeenschappen draaien hun eigen chains, op drie continenten. Grootboeken overleven verloren telefoons.",
    stage2029: "Een open standaard en drie implementaties die niet van ons zijn.",
    stage2030: "Het eerste netwerk op deze standaard dat 9Chain niet beheert. Een miljoen grootboeken.",
    stage2031: "Handelende AI wordt de norm — en AI zonder gezagswortel wordt steeds vaker geweigerd.",
    stage2032: "Veel wortels, één standaard. Het bestuur van de standaard verlaat 9Chain.",
    stage2033: "Grootboeken reizen mee in identiteitswallets, telefoons, berichtenapps en AI-platformen.",
    stage2034: "Telefoons komen met een grootboek uit de fabriek. Een miljard in actief gebruik.",
    stage2035: "Eén chain per persoon. Negen jaar na het eerste blok.",
    stagesNote: "Vier jaar bouwen en bewijzen; in het vijfde maakt de wereld het noodzakelijk; vier jaar waarin anderen het verder dragen dan wij zouden kunnen. Dat laatste deel is het plan, niet het risico.",
    commitTitle: "Wat we beloven niet te doen",
    commit1: "We bewaren je gegevens niet. Het grootboek houdt bewijs bij, niet je privéleven.",
    commit2: "We vragen niet om je papieren. Identiteit is een zaak tussen jou en je gemeenschap.",
    commit3: "We wissen niet. Namen, grootboeken en geschiedenis zijn permanent; ze slapen, ze sterven niet.",
    commit4: "We verplichten je niet een token te kopen om een grootboek te hebben. De standaard is open; LOVE9 is brandstof voor dit netwerk, geen toegangskaartje.",
    commit5: "We bouwen geen eigen AI. We blijven neutraal zodat elke AI je op hetzelfde grootboek kan bedienen.",
    joinTitle: "Negen jaar beginnen bij de eerste mensen",
    joinDesc: "Vandaag is dit een draaiend testnetwerk, met de eerste externe validators en de eerste gemeenschapschains. Alles hieronder staat nu open, voor iedereen.",
    fullDoc: "Het volledige document",
  },
