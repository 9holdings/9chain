...
export const vi: Dict = {
  ...
  validators: {
    title: "Chạy một validator",
    desc: "Câu trên trang chủ của chúng tôi — chín validator chạy trên cùng một máy, cùng một nhà cung cấp — là điểm yếu thật của mạng này, và người ngoài có một cái máy rảnh là thứ duy nhất sửa được nó. Trang này nói việc đó tốn gì, và không trả lại gì.",
    liveTitle: "Bộ validator lúc này",
    liveTotal: "Validator",
    liveConnected: "Đang nối",
    liveMinBond: "Cọc tối thiểu",
    liveAtMinimum: "Đang cọc ở mức tối thiểu",
    measuredNote: "Đọc từ mạng lúc trang này tải, không phải gõ tay. Mức cọc tối thiểu nằm trong binary của node — nó còn là 25.000 cho tới vài giờ trước khi mạng này sinh ra, nên một trang chép số đó từ trí nhớ chỉ cách một lượt sinh lại là nói sai về tiền.",
    costTitle: "Tốn những gì",
    costMachine: "Một cái máy chạy liên tục, và một địa chỉ công khai mở được cổng 9651 từ bên ngoài. Không đơn từ, không danh sách duyệt, không cổng cấp phép ở tầng giao thức — vai vận hành không được cấp cho ai lúc genesis, nên bất kỳ tài khoản nào có tiền đều tham gia được.",
    costBond: "Một khoản tự cọc, khoá suốt kỳ hạn bạn chọn: ngắn nhất 24 giờ, dài nhất 365 ngày.",
    faucetTitle: "LOVE9 lấy ở đâu, và cái bẫy nằm trong phép tính",
    faucetDesc: "Faucet là toàn bộ đường nạp tiền — không phải xin ai, không phải chờ duyệt. Nhưng chín lượt xin ra ĐÚNG bằng mức cọc, và đúng bằng mức cọc là KHÔNG đủ: những giao dịch chuyển tiền của bạn từ C-Chain sang X-Chain rồi sang P-Chain, và giao dịch gửi cọc, đều trả phí từ chính số dư đó. Hãy tính mười lượt và một quãng chờ tới một tiếng cho hạn mức mỗi IP. Chúng tôi nói ở đây chứ không nói ở cuối, vì một bản trước của chính hướng dẫn này viết \"chín lượt là đủ\" rồi tự đính chính ba trăm dòng sau.",
    getTitle: "Bạn nhận được gì",
    getRewards: "Muốn có thưởng thì phải đạt 80% thời gian trực tuyến trong kỳ hạn — cố ý dễ hơn mainnet Avalanche, vì máy của cộng đồng không phải máy trung tâm dữ liệu.",
    getEnd: "Kỳ hạn của bạn hết và không có gì tự gia hạn. Cọc trả lại khi hết hạn; hãy đọc thời điểm kết thúc của chính bạn từ chain thay vì tính trên giấy.",
    getPrivacy: "Không có gì bắt bạn phải mở một endpoint RPC, và chúng tôi mong bạn đừng mở cổng 9650 chút nào. Node của bạn là của bạn.",
    honestTitle: "Việc này KHÔNG trả cho bạn cái gì",
    honest1: "LOVE9 là token thử nghiệm. Nó không có giá trị ở đây và cũng không có giá trị ở đâu khác, không ai mua nó, và không có lời hứa nào rằng thứ này sau sẽ đổi được thành gì.",
    honest2: "A1 là mạng thử nghiệm và đã bị sinh lại từ block 0 hai lần. Nếu chuyện đó xảy ra lần nữa thì cọc, phần thưởng và danh tính node của bạn đi theo. Thứ chúng tôi cam kết là báo trước và nói thẳng cái gì sẽ mất — chỉ có vậy.",
    honest3: "Sau một router ở nhà, node vẫn khởi động và validate được bằng chính những kết nối nó tự mở ra, và trông hoàn toàn khoẻ mạnh trong khi không ai ngoài kia với tới được nó. Đó là cách validator đầu tiên từ bên ngoài kết thúc một kỳ hạn với 14% uptime và không nhận được gì. Hãy chuyển tiếp cổng 9651, và khai địa chỉ công khai đúng bằng địa chỉ mà lượt chuyển tiếp đó trả lời.",
    stepsTitle: "Đường đi, sáu bước",
    step1: "Lấy mã nguồn và dựng lại bản fork, rồi tự đối chiếu vân tay cây tệp — và kiểm luôn rằng một đầu vào cố ý sai thì phải hỏng, để phép kiểm đầu tiên có nghĩa.",
    step2: "Dựng image của node, đóng dấu commit bạn đã dựng từ đó.",
    step3: "Lấy genesis và một địa chỉ bootstrap, kiểm vân tay genesis trước khi chạy bất cứ thứ gì.",
    step4: "Chạy node. Danh tính của nó là ba tệp trên đĩa: mất chúng là cọc của bạn thuộc về một node không còn tồn tại.",
    step5: "Xác nhận bạn đang ở đúng chain bằng cách đọc ngược tên mạng và chain ID, không phải bằng cách tin một mã 200.",
    step6: "Chuyển LOVE9 sang P-Chain rồi đặt cọc — và nghiệm thu kết quả trên chain chứ không phải trong dòng chữ công cụ in ra.",
    guideCta: "Hướng dẫn đầy đủ, từng lệnh một",
    issuesCta: "Báo lỗi",
  ...
  nineYears: {
    title: "Chín năm, chín tỷ",
    lede: "Ngày 2026-09-09, hai câu được khắc vào block đầu tiên của 9Chain, và chín năm bắt đầu đếm. Tới 2035, Liên Hợp Quốc dự báo Trái Đất có gần chín tỷ người. Mục tiêu của chín năm đó là mỗi người trong số họ sở hữu một blockchain của riêng mình.",
    oneLine: "AI của tôi phải xin phép — và có một nơi ghi lại rằng nó đã xin. Nơi đó là của tôi.",
    whatTitle: "Chuyện gì đang xảy ra",
    what1: "Hơn một tỷ người dùng AI mỗi tuần. Hôm nay AI trả lời. Ngày mai nó hành động: đặt chỗ, trả tiền, thương lượng, ký, và đại diện cho bạn trước AI của người khác.",
    what2: "Việc đó dựng lên một câu hỏi loài người chưa từng phải trả lời: AI của tôi được phép làm gì, và ai giữ bằng chứng? Hôm nay câu trả lời là công ty bán AI cho bạn. Họ giữ quyền, họ giữ nhật ký, và họ là trọng tài khi có chuyện.",
    what3: "Một câu lệnh “đừng tiêu quá hai mươi đô” không phải một giới hạn — AI có thể bị lừa, bị thuyết phục, bị chèn lệnh. Giới hạn thật nằm NGOÀI AI, ở một chỗ nó không sửa được, và chỗ đó thuộc về bạn.",
    promisesTitle: "Năm lời hứa",
    promise1: "Chủ quyền — không ai, kể cả 9Chain, sửa, xoá hay khoá được sổ của bạn. Luật của nó là luật bạn đặt.",
    promise2: "Bền lâu — mất điện thoại không mất sổ. Nó sống lâu hơn mọi thiết bị và mọi công ty.",
    promise3: "Kiểm chứng được — bạn không thể lặng lẽ viết lại quá khứ, và ai cũng kiểm được điều đó. Bằng chứng của bạn không nằm trong tay phía bên kia.",
    promise4: "Mang đi được — đổi nơi lưu, đổi nhà cung cấp, đổi quốc gia; tên và lịch sử của bạn đi theo.",
    promise5: "Nối được với nhau — sổ của bạn nói chuyện được với sổ của người khác, với cửa hàng, với cộng đồng.",
    promiseNot: "Có một điều chúng tôi KHÔNG hứa: rằng chain của bạn chạy mãi mãi. Nó không cần thế. Sổ của bạn ngủ khi bạn ngủ, và ai cần đọc thì đọc bản đã neo.",
    constitutionTitle: "Một bản hiến pháp, không phải một câu lệnh",
    constitutionDesc: "Sổ của bạn mang một hợp đồng đang chạy: AI nào được ký thay bạn, được làm gì, tới mức nào, tới bao giờ, và khi nào phải dừng lại hỏi lại. Thu hồi bằng một cái chạm, không cần ai cho phép. Mọi hành động để lại một biên nhận có chữ ký và dấu thời gian.",
    constitutionStd: "Là hợp đồng chứ không phải lời dặn, vì hợp đồng là thứ duy nhất AI không nói vòng qua được. Nó dùng đúng những chuẩn mà thế giới đang hội tụ về, nên AI của bất kỳ công ty nào cũng đọc được — chúng tôi không đẻ ra một ngôn ngữ riêng.",
    treeTitle: "Một cái cây, không phải một cái tháp",
    treeDesc: "Chín tỷ cuốn sổ không nằm trên một mạng. Mỗi tầng đăng ký và neo cho tầng dưới, và chỉ KIỂM bằng chứng chứ không chạy lại — nên cây lớn lên bằng cách thêm cành, không phải bằng cách làm gốc to ra.",
    treeRoot: "Gốc — nhỏ, bền, cố ý nhàm chán. Giữ tên và giữ mỏ neo. 9Chain là một gốc trong nhiều gốc.",
    treeTrunk: "Thân — một vùng, một quốc gia, một liên minh cộng đồng.",
    treeBranch: "Cành — một câu lạc bộ, một trường học, một công ty, một khu phố, do chính cộng đồng đó vận hành.",
    treeLeaf: "Lá — của bạn. Chín tỷ chiếc.",
    stagesTitle: "Chín năm, chín chặng",
    stage2027: "Một trăm người thật đầu tiên, trong một cộng đồng thật, với AI làm việc dưới một bản hiến pháp.",
    stage2028: "Mười cộng đồng tự chạy chain của mình, trên ba châu lục. Sổ sống sót qua điện thoại mất.",
    stage2029: "Một chuẩn mở, và ba bản triển khai không phải của chúng tôi.",
    stage2030: "Mạng đầu tiên chạy chuẩn này mà 9Chain không vận hành. Một triệu cuốn sổ.",
    stage2031: "AI biết hành động thành mặc định — và AI không có gốc thẩm quyền bắt đầu bị từ chối.",
    stage2032: "Nhiều gốc, một chuẩn. Quyền quản trị chuẩn rời khỏi 9Chain.",
    stage2033: "Sổ đi vào trong ví định danh, điện thoại, ứng dụng nhắn tin, nền tảng AI.",
    stage2034: "Điện thoại xuất xưởng kèm một cuốn sổ. Một tỷ cuốn đang dùng.",
    stage2035: "Mỗi người một chain. Chín năm kể từ block đầu tiên.",
    stagesNote: "Bốn năm để dựng và chứng minh; năm thứ năm thế giới làm nó thành bắt buộc; bốn năm để người khác mang nó đi xa hơn chúng tôi làm được. Vế cuối là KẾ HOẠCH, không phải rủi ro.",
    commitTitle: "Những điều chúng tôi cam kết KHÔNG làm",
    commit1: "Chúng tôi không giữ dữ liệu của bạn. Sổ giữ bằng chứng, không giữ đời tư.",
    commit2: "Chúng tôi không đòi giấy tờ. Danh tính là chuyện giữa bạn và cộng đồng của bạn.",
    commit3: "Chúng tôi không xoá. Tên, sổ và lịch sử là vĩnh viễn; chúng ngủ, chúng không chết.",
    commit4: "Chúng tôi không bắt bạn mua token để có một cuốn sổ. Chuẩn là mở; LOVE9 là xăng của mạng này, không phải vé vào cửa.",
    commit5: "Chúng tôi không làm AI của riêng mình. Chúng tôi giữ thế trung lập để mọi AI đều phục vụ bạn được trên cùng một cuốn sổ.",
    joinTitle: "Chín năm bắt đầu từ những người đầu tiên",
    joinDesc: "Hôm nay đây là một mạng thử nghiệm đang chạy, đã có những validator đầu tiên từ bên ngoài và những chain cộng đồng đầu tiên. Mọi thứ dưới đây đang mở, ngay bây giờ, cho bất kỳ ai.",
    fullDoc: "Bản đầy đủ",
  },
