...
export const id: Tu = {
  ...
  home: {
    ...
    disclosure: 'Ke-9 validator saat ini berjalan di server yang sama, dengan penyedia yang sama — terdesentralisasi pada tingkat protokol, belum pada tingkat infrastruktur.',
