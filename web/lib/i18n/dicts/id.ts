...
export const id: Dict = {
  ...
  validators: {
    title: "Jalankan sebuah validator",
    desc: "Kalimat di halaman depan kami — sembilan validator berjalan di satu mesin, di satu penyedia — adalah kelemahan jujur jaringan ini, dan orang luar dengan satu mesin menganggur adalah satu-satunya yang bisa memperbaikinya. Halaman ini menjelaskan biayanya, dan apa yang tidak dibayarnya.",
    liveTitle: "Himpunan validator saat ini",
    liveTotal: "Validator",
    liveConnected: "Terhubung",
    liveMinBond: "Jaminan diri minimum",
    liveAtMinimum: "Bertaruh di minimum",
    measuredNote: "Dibaca dari jaringan saat halaman ini dimuat, bukan diketik. Jaminan minimum dikompilasi ke dalam biner node — nilainya 25.000 sampai beberapa jam sebelum jaringan ini dibuat, jadi halaman yang mengutipnya dari ingatan hanya berjarak satu pembangunan ulang dari salah bicara soal uang.",
    costTitle: "Apa biayanya",
    costMachine: "Sebuah mesin yang tetap menyala, dan alamat publik dengan port 9651 dapat dijangkau dari luar. Tidak ada pengajuan, tidak ada daftar izin, tidak ada gerbang izin di tingkat protokol — peran operator tidak diberikan kepada siapa pun saat genesis, sehingga akun bersaldo apa pun dapat bergabung.",
    costBond: "Jaminan sendiri, terkunci selama masa yang Anda pilih: paling singkat 24 jam, paling lama 365 hari.",
    faucetTitle: "Dari mana LOVE9 berasal, dan jebakan dalam hitungannya",
    faucetDesc: "Faucet adalah seluruh jalur pendanaan — tak ada yang perlu diajukan, tak ada yang perlu dimintai. Tetapi sembilan permintaan tepat sama dengan jaminan, dan tepat sama TIDAK cukup: transaksi yang memindahkan saldo Anda dari C-Chain ke X-Chain lalu ke P-Chain, dan yang mengirim taruhan, dibayar dari saldo yang sama. Anggarkan sepuluh permintaan dan tunggu hingga satu jam untuk batas per IP. Kami menyampaikannya di sini, bukan di akhir, karena versi lama panduan kami sendiri menulis \"sembilan sudah cukup\" dan baru meralatnya tiga ratus baris kemudian.",
    getTitle: "Apa yang Anda dapat",
    getRewards: "Imbalan menuntut 80% waktu aktif sepanjang masa Anda — sengaja lebih longgar daripada mainnet Avalanche, karena perangkat keras komunitas bukan perangkat keras pusat data.",
    getEnd: "Masa Anda berakhir dan tidak ada yang diperpanjang otomatis. Taruhan kembali saat kedaluwarsa; baca waktu berakhir Anda sendiri dari rantai, jangan hitung di atas kertas.",
    getPrivacy: "Tidak ada yang mengharuskan Anda membuka RPC, dan kami lebih suka Anda tidak membuka port 9650 sama sekali. Node Anda milik Anda.",
    honestTitle: "Apa yang tidak dibayarnya",
    honest1: "LOVE9 adalah token uji. Tidak bernilai di sini maupun di tempat lain, tak ada yang membelinya, dan tak ada janji bahwa ini akan berubah menjadi sesuatu nanti.",
    honest2: "A1 adalah testnet dan sudah dua kali dibangun ulang dari blok 0. Jika terjadi lagi, taruhan, imbalan, dan identitas node Anda ikut hilang. Yang kami janjikan adalah memberitahukan lebih dulu dan menyebut dengan jelas apa yang hilang — hanya itu janjinya.",
    honest3: "Di balik router rumah, node tetap bisa bootstrap dan memvalidasi lewat koneksi yang dibukanya sendiri, dan tampak sehat sepenuhnya padahal tak seorang pun dari luar bisa menjangkaunya. Begitulah validator luar pertama menyelesaikan satu masa dengan 14% waktu aktif dan tidak memperoleh apa pun. Teruskan port 9651, dan tetapkan alamat publik ke alamat yang dijawab oleh penerusan itu.",
    stepsTitle: "Jalannya, dalam enam langkah",
    step1: "Ambil sumbernya dan bangun ulang fork-nya, lalu periksa sendiri hash pohonnya — dan periksa juga bahwa masukan yang sengaja salah gagal, agar pemeriksaan pertama berarti sesuatu.",
    step2: "Bangun image node, dengan mencantumkan commit asal build Anda.",
    step3: "Ambil genesis dan satu alamat bootstrap, lalu verifikasi hash genesis sebelum menjalankan apa pun.",
    step4: "Jalankan node. Identitasnya adalah tiga berkas di disk: kehilangan berkas itu berarti jaminan Anda milik node yang sudah tidak ada.",
    step5: "Pastikan Anda di rantai yang benar dengan membaca kembali nama jaringan dan chain ID, bukan dengan mempercayai kode 200.",
    step6: "Pindahkan LOVE9 ke P-Chain, lalu bertaruh — dan verifikasi hasilnya di rantai, bukan di keluaran alat.",
    guideCta: "Panduan lengkap, setiap perintah",
  ...
  nineYears: {
    title: "Sembilan tahun, sembilan miliar",
    lede: "Pada 2026-09-09 dua kalimat masuk ke blok pertama 9Chain, dan sembilan tahun mulai dihitung. Menjelang 2035 PBB memperkirakan Bumi dihuni hampir sembilan miliar orang. Tujuan sembilan tahun itu: setiap orang di antara mereka memiliki blockchain sendiri.",
    oneLine: "AI saya harus meminta izin — dan ada tempat yang mencatat bahwa ia meminta. Tempat itu milik saya.",
    whatTitle: "Apa yang sedang terjadi",
    what1: "Lebih dari satu miliar orang memakai AI setiap minggu. Hari ini AI menjawab. Besok ia bertindak: memesan, membayar, menawar, menandatangani, dan mewakili Anda di hadapan AI orang lain.",
    what2: "Itu memunculkan pertanyaan yang belum pernah harus dijawab manusia: apa yang boleh dilakukan AI saya, dan siapa yang memegang buktinya? Hari ini jawabannya perusahaan yang menjual AI itu kepada Anda. Izin di tangan mereka, catatan di tangan mereka, dan merekalah wasitnya ketika terjadi masalah.",
    what3: "Perintah “jangan belanjakan lebih dari dua puluh dolar” bukanlah batas — AI bisa ditipu, dibujuk, disusupi. Batas yang sungguh-sungguh hidup di luar AI, di tempat yang tak bisa ia sunting, dan tempat itu milik Anda.",
    promisesTitle: "Lima janji",
    promise1: "Kedaulatan — tak seorang pun, bahkan 9Chain, dapat menyunting, menghapus, atau mengunci buku Anda. Aturannya adalah aturan Anda.",
    promise2: "Ketahanan — kehilangan ponsel bukan kehilangan buku. Ia hidup lebih lama daripada setiap perangkat dan setiap perusahaan.",
    promise3: "Keterverifikasian — Anda tidak bisa diam-diam menulis ulang masa lalu, dan siapa pun bisa memeriksanya. Bukti Anda tidak dipegang pihak lawan.",
    promise4: "Keterbawaan — ganti hos, penyedia, atau negara; nama dan riwayat Anda ikut serta.",
    promise5: "Keterhubungan — buku Anda berbicara dengan buku orang lain, dengan toko, dengan komunitas.",
    promiseNot: "Satu hal yang tidak kami janjikan: rantai Anda berjalan selamanya. Itu tidak perlu. Buku Anda tidur saat Anda tidur, dan siapa pun yang perlu membacanya membaca salinan yang telah ditambatkan.",
    constitutionTitle: "Sebuah konstitusi, bukan sebuah perintah",
    constitutionDesc: "Buku Anda memuat kontrak yang berjalan: AI mana yang boleh menandatangani atas nama Anda, apa yang boleh dilakukannya, sampai berapa, sampai kapan, dan kapan ia harus berhenti dan bertanya lagi. Dicabut dengan satu sentuhan, tanpa izin siapa pun. Setiap tindakan meninggalkan tanda terima bertanda tangan dan berstempel waktu.",
    constitutionStd: "Kontrak, bukan instruksi, karena kontrak adalah satu-satunya hal yang tak bisa dilewati AI dengan kata-kata. Ia berbicara dalam standar yang memang sedang dituju dunia, sehingga AI perusahaan mana pun dapat membacanya — kami tidak menciptakan bahasa sendiri untuknya.",
    treeTitle: "Sebuah pohon, bukan menara",
    treeDesc: "Sembilan miliar buku tidak muat di satu jaringan. Setiap lapis mendaftarkan dan menambatkan lapis di bawahnya, dan memverifikasi bukti alih-alih menjalankannya ulang — jadi pohon tumbuh dengan menambah cabang, bukan menebalkan akar.",
    treeRoot: "Akar — kecil, tahan lama, sengaja membosankan. Menyimpan nama dan tambatan. 9Chain hanyalah satu akar di antara banyak.",
    treeTrunk: "Batang — sebuah kawasan, sebuah negara, sebuah aliansi komunitas.",
    treeBranch: "Cabang — sebuah klub, sekolah, perusahaan, lingkungan; dijalankan oleh komunitas itu sendiri.",
    treeLeaf: "Daun — milik Anda. Sembilan miliar helai.",
    stagesTitle: "Sembilan tahun, sembilan tahap",
    stage2027: "Seratus orang nyata pertama, di satu komunitas nyata, dengan AI bekerja di bawah sebuah konstitusi.",
    stage2028: "Sepuluh komunitas menjalankan rantai mereka sendiri di tiga benua. Buku selamat dari ponsel yang hilang.",
    stage2029: "Sebuah standar terbuka, dan tiga implementasi yang bukan milik kami.",
    stage2030: "Jaringan pertama yang menjalankan standar ini tanpa dioperasikan 9Chain. Satu juta buku.",
    stage2031: "AI yang bertindak menjadi hal biasa — dan AI tanpa akar kewenangan mulai ditolak.",
    stage2032: "Banyak akar, satu standar. Tata kelola standar meninggalkan 9Chain.",
    stage2033: "Buku ikut masuk ke dompet identitas, ponsel, aplikasi pesan, dan platform AI.",
    stage2034: "Ponsel dikirim dari pabrik dengan sebuah buku. Satu miliar dipakai aktif.",
    stage2035: "Satu rantai per orang. Sembilan tahun sejak blok pertama.",
    stagesNote: "Empat tahun membangun dan membuktikan; pada tahun kelima dunia menjadikannya keharusan; empat tahun ketika orang lain membawanya lebih jauh daripada yang mampu kami lakukan. Bagian terakhir itu rencana, bukan risiko.",
    commitTitle: "Yang kami janjikan untuk tidak dilakukan",
    commit1: "Kami tidak menyimpan data Anda. Buku menyimpan bukti, bukan kehidupan pribadi Anda.",
    commit2: "Kami tidak meminta dokumen Anda. Identitas adalah urusan Anda dan komunitas Anda.",
    commit3: "Kami tidak menghapus. Nama, buku, dan riwayat bersifat permanen; mereka tidur, bukan mati.",
    commit4: "Kami tidak mewajibkan Anda membeli token untuk memiliki buku. Standarnya terbuka; LOVE9 adalah bahan bakar jaringan ini, bukan tiket masuk.",
    commit5: "Kami tidak membangun AI sendiri. Kami tetap netral agar setiap AI dapat melayani Anda di atas buku yang sama.",
    joinTitle: "Sembilan tahun dimulai dari orang-orang pertama",
    joinDesc: "Hari ini ini adalah jaringan uji yang berjalan, dengan validator luar pertamanya dan rantai komunitas pertamanya. Semua di bawah ini terbuka, sekarang, bagi siapa saja.",
