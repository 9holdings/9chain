...
export const zh: Dict = {
  ...
  nineYears: {
    title: "九年，九十亿",
    lede: "2026-09-09，两句话被刻进 9Chain 的第一个区块，九年开始计时。到 2035 年，联合国预计地球上将有近九十亿人。这九年的目标是：他们每一个人都拥有一条属于自己的区块链。",
    oneLine: "我的 AI 必须先请求许可——并且有一个地方记录着它请求过。那个地方是我的。",
    whatTitle: "正在发生什么",
    what1: "每周有超过十亿人使用 AI。今天 AI 回答问题，明天它开始行动：预订、付款、谈判、签署，并在别人的 AI 面前代表你。",
    what2: "这带来一个人类从未需要回答的问题：我的 AI 被允许做什么，证据由谁掌握？今天的答案是——卖给你 AI 的那家公司。权限在他们手里，日志在他们手里，出事时裁判也是他们。",
    what3: "一句“不要花超过二十美元”的提示不是限制——AI 会被欺骗、被说服、被注入。真正的限制必须在 AI 之外，在它无法修改的地方，并且属于你。",
    promisesTitle: "五项承诺",
    promise1: "主权——没有人，包括 9Chain，可以修改、删除或锁定你的账本。它的规则是你定的。",
    promise2: "长存——丢了手机不会丢了账本。它比任何设备、任何公司都活得久。",
    promise3: "可验证——你无法悄悄改写过去，而任何人都能核验这一点。你的证据不掌握在对方手里。",
    promise4: "可携带——换托管方、换服务商、换国家，你的名字和历史随你而行。",
    promise5: "可互通——你的账本能与他人的账本、与商家、与社区对话。",
    promiseNot: "有一件事我们不承诺：你的链会永远运行。它不需要。你睡时账本也睡，需要查阅的人读取已锚定的副本。",
    constitutionTitle: "一部宪法，而不是一句提示",
    constitutionDesc: "你的账本承载一份正在运行的合约：哪个 AI 可以替你签署、能做什么、上限多少、有效到何时，以及何时必须停下再问你一次。一键撤销，无需任何人批准。每一次行动都留下带签名和时间戳的收据。",
    constitutionStd: "之所以是合约而非指令，因为合约是 AI 唯一无法用话术绕过的东西。它使用世界正在收敛的那些标准，因此任何公司的 AI 都能读懂——我们没有为它发明一种私有语言。",
    treeTitle: "一棵树，而不是一座塔",
    treeDesc: "九十亿个账本不会挤在一个网络上。每一层为下一层做登记与锚定，并且只验证证明而不重跑它们——所以这棵树靠长出枝条来生长，而不是把根变粗。",
    treeRoot: "根——小、耐久、刻意乏味。保管名字与锚点。9Chain 只是众多根之一。",
    treeTrunk: "干——一个地区、一个国家、一个社区联盟。",
    treeBranch: "枝——一个俱乐部、一所学校、一家公司、一个街区，由该社区自己运行。",
    treeLeaf: "叶——你的。九十亿片。",
    stagesTitle: "九年，九个阶段",
    stage2027: "第一批一百个真实的人，在一个真实的社区里，AI 在宪法之下工作。",
    stage2028: "十个社区在三大洲自行运行自己的链。账本在手机丢失后依然存在。",
    stage2029: "一个开放标准，以及三个并非出自我们之手的实现。",
    stage2030: "第一个运行该标准、但不由 9Chain 运营的网络。一百万个账本。",
    stage2031: "会行动的 AI 成为默认——没有权限根基的 AI 开始被拒绝。",
    stage2032: "多个根，一个标准。标准的治理权离开 9Chain。",
    stage2033: "账本进入身份钱包、手机、通讯软件与 AI 平台之中。",
    stage2034: "手机出厂即带账本。十亿个在实际使用中。",
    stage2035: "每人一条链。距第一个区块整九年。",
    stagesNote: "四年用来建造与证明；第五年世界让它成为必需；最后四年由别人把它带得比我们更远。最后那一段是计划，不是风险。",
    commitTitle: "我们承诺不做的事",
    commit1: "我们不保存你的数据。账本保存的是证据，不是你的私生活。",
    commit2: "我们不索要你的证件。身份是你与你的社区之间的事。",
    commit3: "我们不删除。名字、账本与历史都是永久的；它们会沉睡，不会消亡。",
    commit4: "我们不要求你买代币才能拥有账本。标准是开放的；LOVE9 是这条网络的燃料，不是门票。",
    commit5: "我们不做自己的 AI。我们保持中立，好让每一个 AI 都能在同一个账本上为你服务。",
    joinTitle: "九年从最早的一批人开始",
    joinDesc: "今天这是一个正在运行的测试网络，已经有了第一批外部验证者和第一批社区链。下面的一切现在就是开放的，向任何人。",
    fullDoc: "完整文档",
  },
