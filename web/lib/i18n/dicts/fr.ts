...
export const fr: Dict = {
  ...
  home: {
    ...
    disclosure: 'Les 9 validateurs tournent actuellement sur le même serveur, chez le même hébergeur — décentralisé au niveau du protocole, pas encore au niveau de l’infrastructure.',
