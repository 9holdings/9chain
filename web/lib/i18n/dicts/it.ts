...
export const it: Dict = {
  ...
  nav: {
    ...
    validators: "Far girare un validatore",
    docs: "Documentazione",
    nineYears: "Nove anni, nove miliardi",
  },
  ...
  docs: {
    ...
    desc: "Tutto ciò che è scritto sull'uso di A1: come lanciare una catena, come far girare un validatore e a cosa serve il progetto. Ogni documento rimanda dove vive davvero, quindi ciò che leggi è la copia che viene modificata.",
    langNote: "Ogni documento è nella lingua indicata sulla sua riga, e non traduciamo i documenti stessi. Una copia tradotta resta corretta solo finché qualcuno non corregge un comando nell'originale — e a sbagliare è la copia che nessuno modifica.",
    langLabel: "Lingua",
    alsoIn: "Anche in",
    pdfLabel: "PDF",
    onSiteLabel: "Su questo sito",
    opensGithub: "Si apre su GitHub",
  },
  nineYears: {
    title: "Nove anni, nove miliardi",
    lede: "Il 2026-09-09 due frasi entrano nel primo blocco di 9Chain e iniziano a contare nove anni. Entro il 2035 l'ONU prevede sulla Terra quasi nove miliardi di persone. L'obiettivo di quei nove anni è che ciascuna di loro possieda una blockchain propria.",
    oneLine: "La mia IA deve chiedere il permesso — ed esiste un luogo che registra che l'ha chiesto. Quel luogo è mio.",
    whatTitle: "Che cosa sta succedendo",
    what1: "Più di un miliardo di persone usa l'IA ogni settimana. Oggi l'IA risponde. Domani agisce: prenota, paga, tratta, firma e vi rappresenta davanti all'IA di qualcun altro.",
    what2: "Da qui una domanda a cui l'umanità non ha mai dovuto rispondere: che cosa può fare la mia IA, e chi custodisce le prove? Oggi la risposta è l'azienda che vi vende l'IA. I permessi sono suoi, i registri sono suoi, ed è lei l'arbitro quando qualcosa va storto.",
    what3: "Un'istruzione del tipo «non spendere più di venti dollari» non è un limite: un'IA si può ingannare, convincere, manipolare. Un limite vero vive fuori dall'IA, dove non può modificarlo, e appartiene a voi.",
    promisesTitle: "Cinque promesse",
    promise1: "Sovranità — nessuno, nemmeno 9Chain, può modificare, cancellare o bloccare il vostro registro. Le sue regole sono quelle che fissate voi.",
    promise2: "Permanenza — perdere il telefono non significa perdere il registro. Sopravvive a ogni dispositivo e a ogni azienda.",
    promise3: "Verificabilità — non potete riscrivere il passato in silenzio, e chiunque può controllarlo. Le vostre prove non stanno dall'altra parte.",
    promise4: "Portabilità — cambiate host, fornitore o paese: nome e storia vi seguono.",
    promise5: "Interoperabilità — il vostro registro parla con quelli degli altri, con i negozi, con le comunità.",
    promiseNot: "Una promessa non la facciamo: che la vostra catena giri per sempre. Non serve. Il vostro registro dorme quando dormite voi, e chi deve leggerlo legge la copia ancorata.",
    constitutionTitle: "Una costituzione, non un'istruzione",
    constitutionDesc: "Il vostro registro porta un contratto che gira: quale IA può firmare per voi, cosa può fare, fino a quanto, fino a quando, e quando deve fermarsi e chiedere di nuovo. Revocabile con un tocco, senza il permesso di nessuno. Ogni azione lascia una ricevuta firmata e datata.",
    constitutionStd: "Un contratto e non un'indicazione, perché il contratto è l'unica cosa che un'IA non può aggirare parlando. Parla gli standard verso cui il mondo sta già convergendo, così l'IA di qualsiasi azienda può leggerlo: non abbiamo inventato un linguaggio privato.",
    treeTitle: "Un albero, non una torre",
    treeDesc: "Nove miliardi di registri non stanno su una sola rete. Ogni livello registra e ancora quello sotto, e verifica le prove invece di rieseguirle: così l'albero cresce aggiungendo rami, non ingrossando la radice.",
    treeRoot: "Radice — piccola, duratura, volutamente noiosa. Custodisce nomi e ancoraggi. 9Chain è una radice fra tante.",
    treeTrunk: "Tronco — una regione, un paese, un'alleanza di comunità.",
    treeBranch: "Ramo — un circolo, una scuola, un'azienda, un quartiere, gestito da quella stessa comunità.",
    treeLeaf: "Foglia — la vostra. Nove miliardi di foglie.",
    stagesTitle: "Nove anni, nove tappe",
    stage2027: "Le prime cento persone vere, in una comunità vera, con IA che lavorano sotto una costituzione.",
    stage2028: "Dieci comunità gestiscono da sole le proprie catene, su tre continenti. I registri sopravvivono ai telefoni persi.",
    stage2029: "Uno standard aperto e tre implementazioni che non sono nostre.",
    stage2030: "La prima rete che esegue lo standard senza essere gestita da 9Chain. Un milione di registri.",
    stage2031: "L'IA che agisce diventa la norma — e un'IA senza radice di autorità comincia a essere rifiutata.",
    stage2032: "Molte radici, uno standard. Il governo dello standard esce da 9Chain.",
    stage2033: "I registri viaggiano dentro portafogli di identità, telefoni, app di messaggistica, piattaforme di IA.",
    stage2034: "I telefoni escono di fabbrica con un registro. Un miliardo in uso reale.",
    stage2035: "Una catena a testa. Nove anni dal primo blocco.",
    stagesNote: "Quattro anni per costruire e dimostrare; al quinto il mondo lo rende necessario; quattro anni in cui altri lo portano più lontano di quanto potremmo noi. Quest'ultima parte è il piano, non un rischio.",
    commitTitle: "Ciò che ci impegniamo a non fare",
    commit1: "Non conserviamo i vostri dati. Il registro tiene prove, non la vostra vita privata.",
    commit2: "Non chiediamo documenti. L'identità è una questione fra voi e la vostra comunità.",
    commit3: "Non cancelliamo. Nomi, registri e storia sono permanenti; dormono, non muoiono.",
    commit4: "Non vi obblighiamo a comprare un token per avere un registro. Lo standard è aperto; LOVE9 è carburante di questa rete, non un biglietto d'ingresso.",
    commit5: "Non costruiamo una nostra IA. Restiamo neutrali perché ogni IA possa servirvi sullo stesso registro.",
    joinTitle: "Nove anni cominciano dalle prime persone",
    joinDesc: "Oggi questa è una rete di test in funzione, con i suoi primi validatori esterni e le sue prime catene di comunità. Tutto ciò che segue è aperto, ora, a chiunque.",
    fullDoc: "Il documento completo",
  },
