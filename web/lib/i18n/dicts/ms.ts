...
export const ms: Dict = {
  ...
  home: {
    ...
    disclosure: 'Kesemua 9 pengesah kini berjalan pada pelayan yang sama, dengan penyedia yang sama — terdesentralisasi pada peringkat protokol, belum lagi pada peringkat infrastruktur.',
