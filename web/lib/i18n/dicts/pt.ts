...
export const pt: Dict = {
  ...
  nav: {
    ...
    validators: "Executar um validador",
    docs: "Documentação",
    nineYears: "Nove anos, nove mil milhões",
  },
  ...
  validators: {
    title: "Executar um validador",
    desc: "A frase na nossa página inicial — nove dos validadores numa só máquina, num só fornecedor — é a fraqueza honesta desta rede, e alguém de fora com uma máquina disponível é a única coisa que a corrige. Esta página diz o que isso custa, e o que não paga.",
    liveTitle: "O conjunto neste momento",
    liveTotal: "Validadores",
    liveConnected: "Ligados",
    liveMinBond: "Caução mínima",
    liveAtMinimum: "No mínimo",
    measuredNote: "Lido da rede quando esta página carregou, não escrito à mão. A caução mínima está compilada no binário do nó — era 25.000 até às horas antes de esta rede ser criada, por isso uma página que a cite de memória está a uma reconstrução de se enganar sobre dinheiro.",
    costTitle: "O que custa",
    costMachine: "Uma máquina que fique ligada e um endereço público com a porta 9651 acessível de fora. Não há candidatura, nem lista de permissões, nem porta de autorização ao nível do protocolo — o papel de operador não é concedido a ninguém no génesis, por isso qualquer conta com fundos pode entrar.",
    costBond: "Uma caução própria, bloqueada durante o prazo que escolher: 24 horas no mínimo, 365 dias no máximo.",
    faucetTitle: "De onde vem o LOVE9, e a armadilha na aritmética",
    faucetDesc: "A torneira é todo o caminho de financiamento — nada a requerer, ninguém a pedir. Mas nove pedidos dão exatamente a caução, e exatamente a caução NÃO chega: as transações que levam o seu saldo da C-Chain para a X-Chain e depois para a P-Chain, e a que submete o stake, são pagas com esse mesmo saldo. Conte com dez pedidos e até uma hora de espera pelo limite por IP. Dizemo-lo aqui e não no fim, porque uma versão anterior do nosso próprio guia dizia «nove chegam» e corrigia-se trezentas linhas depois.",
    getTitle: "O que recebe",
    getRewards: "As recompensas exigem 80% de disponibilidade ao longo do prazo — deliberadamente mais folgado do que a mainnet da Avalanche, porque o hardware da comunidade não é hardware de centro de dados.",
    getEnd: "O seu prazo termina e nada se renova sozinho. O stake volta quando expira; leia a sua própria hora de fim na cadeia em vez de a calcular.",
    getPrivacy: "Nada o obriga a expor um RPC, e preferíamos que não abrisse de todo a porta 9650. O seu nó é seu.",
    honestTitle: "O que isto não paga",
    honest1: "LOVE9 é um token de teste. Não vale nada aqui nem em lado nenhum, ninguém o está a comprar, e não há promessa de que isto se converta em algo mais tarde.",
    honest2: "A1 é uma testnet e já foi reconstruída do bloco 0 duas vezes. Se acontecer outra vez, o seu stake, as suas recompensas e a identidade do seu nó vão com ela. O que prometemos é avisar antes e dizer com clareza o que se perde — é toda a promessa.",
    honest3: "Atrás de um router doméstico, um nó arranca e valida com as ligações que ele próprio abre, e parece perfeitamente saudável enquanto ninguém de fora lhe consegue chegar. Foi assim que o primeiro validador externo terminou um prazo com 14% de disponibilidade e não ganhou nada. Encaminhe a porta 9651 e ponha como endereço público aquele onde esse encaminhamento responde.",
    stepsTitle: "O caminho, em seis passos",
    step1: "Obtenha o código e reconstrua o fork, depois verifique você mesmo o hash da árvore — e verifique que uma entrada deliberadamente errada falha, para que a primeira verificação signifique alguma coisa.",
    step2: "Construa a imagem do nó, gravando nela o commit de que partiu.",
    step3: "Obtenha o génesis e um endereço de arranque, e verifique o hash do génesis antes de executar seja o que for.",
    step4: "Ponha o nó a correr. A identidade dele são três ficheiros em disco: perdê-los é deixar a sua caução a um nó que já não existe.",
    step5: "Confirme que está na cadeia certa lendo de volta o nome da rede e o chain ID, e não confiando num 200.",
    step6: "Leve LOVE9 para a P-Chain e faça stake — e verifique o resultado na cadeia, não na saída da ferramenta.",
    guideCta: "O guia completo, com todos os comandos",
  ...
  nineYears: {
    title: "Nove anos, nove mil milhões",
    lede: "A 2026-09-09 duas frases entram no primeiro bloco da 9Chain e começam a contar nove anos. Até 2035 a ONU espera que a Terra tenha perto de nove mil milhões de pessoas. O objetivo desses nove anos é que cada uma delas tenha uma cadeia de blocos própria.",
    oneLine: "A minha IA tem de pedir permissão — e há um lugar que regista que ela pediu. Esse lugar é meu.",
    whatTitle: "O que está a acontecer",
    what1: "Mais de mil milhões de pessoas usam IA todas as semanas. Hoje a IA responde. Amanhã age: reserva, paga, negoceia, assina e representa-o perante a IA de outra pessoa.",
    what2: "O que levanta uma pergunta que a humanidade nunca teve de responder: o que é que a minha IA pode fazer, e quem guarda as provas? Hoje a resposta é a empresa que lhe vende a IA. As permissões são delas, os registos são delas, e são elas o árbitro quando algo corre mal.",
    what3: "Uma instrução a dizer «não gastes mais de vinte dólares» não é um limite — uma IA pode ser enganada, convencida, manipulada. Um limite a sério vive fora da IA, num sítio que ela não pode editar, e pertence-lhe a si.",
    promisesTitle: "Cinco promessas",
    promise1: "Soberania — ninguém, nem sequer a 9Chain, pode editar, apagar ou bloquear o seu registo. As regras dele são as suas.",
    promise2: "Permanência — perder o telemóvel não é perder o registo. Ele sobrevive a qualquer aparelho e a qualquer empresa.",
    promise3: "Verificabilidade — não pode reescrever o passado em silêncio, e qualquer pessoa pode confirmá-lo. As suas provas não estão do outro lado.",
    promise4: "Portabilidade — mude de anfitrião, de fornecedor ou de país; o seu nome e a sua história vão consigo.",
    promise5: "Interoperabilidade — o seu registo fala com os registos de outros, com lojas, com comunidades.",
    promiseNot: "Uma promessa que não fazemos: que a sua cadeia funcione para sempre. Não precisa. O seu registo dorme quando você dorme, e quem precisar de o ler lê a cópia ancorada.",
    constitutionTitle: "Uma constituição, não uma instrução",
    constitutionDesc: "O seu registo carrega um contrato em execução: que IA pode assinar por si, o que pode fazer, até quanto, até quando, e quando tem de parar e voltar a perguntar. Revogável num toque, sem autorização de ninguém. Cada ação deixa um recibo assinado e datado.",
    constitutionStd: "Um contrato em vez de uma indicação, porque um contrato é a única coisa que uma IA não consegue contornar a falar. Fala os padrões para os quais o mundo já converge, por isso a IA de qualquer empresa consegue lê-lo — não inventámos uma linguagem privada.",
    treeTitle: "Uma árvore, não uma torre",
    treeDesc: "Nove mil milhões de registos não cabem numa só rede. Cada nível regista e ancora o de baixo, e verifica provas em vez de as repetir — por isso a árvore cresce acrescentando ramos, não engrossando a raiz.",
    treeRoot: "Raiz — pequena, duradoura, propositadamente aborrecida. Guarda nomes e âncoras. A 9Chain é uma raiz entre muitas.",
    treeTrunk: "Tronco — uma região, um país, uma aliança de comunidades.",
    treeBranch: "Ramo — um clube, uma escola, uma empresa, um bairro, gerido pela própria comunidade.",
    treeLeaf: "Folha — a sua. Nove mil milhões delas.",
    stagesTitle: "Nove anos, nove etapas",
    stage2027: "As primeiras cem pessoas reais, numa comunidade real, com IAs a trabalhar sob uma constituição.",
    stage2028: "Dez comunidades a gerir as suas próprias cadeias, em três continentes. Os registos sobrevivem a telemóveis perdidos.",
    stage2029: "Uma norma aberta, e três implementações que não são nossas.",
    stage2030: "A primeira rede a correr a norma sem ser operada pela 9Chain. Um milhão de registos.",
    stage2031: "A IA que age passa a ser o normal — e uma IA sem raiz de autoridade começa a ser recusada.",
    stage2032: "Muitas raízes, uma norma. A governação da norma sai da 9Chain.",
    stage2033: "Os registos viajam dentro de carteiras de identidade, telemóveis, apps de mensagens e plataformas de IA.",
    stage2034: "Os telemóveis saem de fábrica com um registo. Mil milhões em uso.",
    stage2035: "Uma cadeia por pessoa. Nove anos desde o primeiro bloco.",
    stagesNote: "Quatro anos a construir e a provar; no quinto o mundo torna-o necessário; quatro anos em que outros o levam mais longe do que nós conseguiríamos. Essa última parte é o plano, não um risco.",
    commitTitle: "O que nos comprometemos a não fazer",
    commit1: "Não guardamos os seus dados. O registo guarda provas, não a sua vida privada.",
    commit2: "Não lhe pedimos documentos. A identidade é entre si e a sua comunidade.",
    commit3: "Não apagamos. Nomes, registos e história são permanentes; adormecem, não morrem.",
    commit4: "Não o obrigamos a comprar um token para ter um registo. A norma é aberta; LOVE9 é o combustível desta rede, não um bilhete à porta.",
    commit5: "Não construímos a nossa própria IA. Ficamos neutros para que qualquer IA o possa servir no mesmo registo.",
    joinTitle: "Nove anos começam com as primeiras pessoas",
    joinDesc: "Hoje isto é uma rede de teste a funcionar, com os primeiros validadores de fora e as primeiras cadeias comunitárias. Tudo o que está abaixo está aberto, agora, a qualquer pessoa.",
    fullDoc: "O documento completo",
  },
