...
export const sw: Dict = {
  ...
  nav: {
    ...
    validators: "Endesha kithibitishaji",
    docs: "Nyaraka",
    nineYears: "Miaka tisa, bilioni tisa",
  },
  ...
  nineYears: {
    title: "Miaka tisa, bilioni tisa",
    lede: "Tarehe 2026-09-09 sentensi mbili zinaingizwa katika kitalu cha kwanza cha 9Chain, na miaka tisa inaanza kuhesabiwa. Ifikapo 2035 Umoja wa Mataifa unatarajia Dunia kuwa na karibu watu bilioni tisa. Lengo la miaka hiyo tisa ni kwamba kila mmoja wao amiliki blockchain yake mwenyewe.",
    oneLine: "AI yangu lazima iombe ruhusa — na kuna mahali panapoandika kwamba iliomba. Mahali hapo ni pangu.",
    whatTitle: "Kinachotokea",
    what1: "Zaidi ya watu bilioni moja hutumia AI kila wiki. Leo AI hujibu. Kesho itatenda: itaweka nafasi, italipa, itajadiliana, itatia saini, na itakuwakilisha mbele ya AI ya mtu mwingine.",
    what2: "Hili linazua swali ambalo binadamu hajawahi kulazimika kulijibu: AI yangu inaruhusiwa kufanya nini, na nani anashikilia ushahidi? Leo jibu ni kampuni iliyokuuzia AI. Ruhusa ziko kwao, kumbukumbu ziko kwao, na wao ndio waamuzi mambo yanapoharibika.",
    what3: "Kuandika “usitumie zaidi ya dola ishirini” si kikomo — AI inaweza kudanganywa, kushawishiwa, kuingiziwa maagizo. Kikomo halisi hukaa nje ya AI, mahali ambapo haiwezi kupabadilisha, na mahali hapo ni pako.",
    promisesTitle: "Ahadi tano",
    promise1: "Mamlaka — hakuna yeyote, hata 9Chain, anayeweza kubadilisha, kufuta au kufunga daftari lako. Sheria zake ni ulizoziweka wewe.",
    promise2: "Kudumu — kupoteza simu si kupoteza daftari. Linaishi zaidi ya kila kifaa na kila kampuni.",
    promise3: "Uthibitishaji — huwezi kuandika upya historia kimyakimya, na yeyote anaweza kuhakiki hilo. Ushahidi wako hauko mikononi mwa upande mwingine.",
    promise4: "Ubebekaji — badilisha mwenyeji, mtoa huduma au nchi; jina lako na historia yako vinakwenda nawe.",
    promise5: "Ushirikiano — daftari lako huzungumza na madaftari ya wengine, na maduka, na jamii.",
    promiseNot: "Ahadi moja hatuitoi: kwamba mnyororo wako utafanya kazi milele. Hakuna haja. Daftari lako hulala unapolala, na anayehitaji kulisoma husoma nakala iliyotiwa nanga.",
    constitutionTitle: "Katiba, si maagizo",
    constitutionDesc: "Daftari lako hubeba mkataba unaofanya kazi: ni AI ipi inayoweza kutia saini kwa niaba yako, inaweza kufanya nini, hadi kiasi gani, hadi lini, na ni lini lazima isimame na kuuliza tena. Hufutwa kwa mguso mmoja, bila ruhusa ya mtu yeyote. Kila tendo huacha risiti yenye saini na muhuri wa wakati.",
    constitutionStd: "Mkataba badala ya agizo, kwa sababu mkataba ndicho kitu pekee ambacho AI haiwezi kukizunguka kwa maneno. Unazungumza viwango ambavyo dunia tayari inavielekea, hivyo AI ya kampuni yoyote inaweza kuusoma — hatukubuni lugha yetu wenyewe kwa ajili yake.",
    treeTitle: "Mti, si mnara",
    treeDesc: "Madaftari bilioni tisa hayakai kwenye mtandao mmoja. Kila ngazi husajili na kutia nanga ngazi iliyo chini yake, na huhakiki uthibitisho badala ya kuurudia — hivyo mti hukua kwa kuongeza matawi, si kwa kunenepesha mzizi.",
    treeRoot: "Mzizi — mdogo, imara, wa kuchosha kwa makusudi. Huhifadhi majina na nanga. 9Chain ni mzizi mmoja kati ya mingi.",
    treeTrunk: "Shina — eneo moja, nchi moja, muungano wa jamii.",
    treeBranch: "Tawi — klabu, shule, kampuni, mtaa; huendeshwa na jamii hiyo yenyewe.",
    treeLeaf: "Jani — lako. Majani bilioni tisa.",
    stagesTitle: "Miaka tisa, hatua tisa",
    stage2027: "Watu mia moja halisi wa kwanza, katika jamii moja halisi, wakiwa na AI zinazofanya kazi chini ya katiba.",
    stage2028: "Jamii kumi zinaendesha minyororo yao wenyewe katika mabara matatu. Madaftari yanaokoka simu zilizopotea.",
    stage2029: "Kiwango wazi, na utekelezaji mitatu ambayo si yetu.",
    stage2030: "Mtandao wa kwanza unaotumia kiwango hiki ambao 9Chain haiuendeshi. Madaftari milioni moja.",
    stage2031: "AI inayotenda inakuwa kawaida — na AI isiyo na mzizi wa mamlaka inaanza kukataliwa.",
    stage2032: "Mizizi mingi, kiwango kimoja. Uongozi wa kiwango unaondoka 9Chain.",
    stage2033: "Madaftari husafiri ndani ya pochi za utambulisho, simu, programu za ujumbe, na majukwaa ya AI.",
    stage2034: "Simu hutoka kiwandani zikiwa na daftari. Bilioni moja zinatumika kwa kweli.",
    stage2035: "Mnyororo mmoja kwa kila mtu. Miaka tisa tangu kitalu cha kwanza.",
    stagesNote: "Miaka minne ya kujenga na kuthibitisha; mwaka wa tano dunia inaifanya kuwa lazima; miaka minne ambapo wengine wanaipeleka mbali kuliko tungeweza sisi. Sehemu hiyo ya mwisho ni mpango, si hatari.",
    commitTitle: "Tunachoahidi kutofanya",
    commit1: "Hatuhifadhi data yako. Daftari huhifadhi ushahidi, si maisha yako binafsi.",
    commit2: "Hatuombi vyeti vyako. Utambulisho ni jambo kati yako na jamii yako.",
    commit3: "Hatufuti. Majina, madaftari na historia ni ya kudumu; hulala, hayafi.",
    commit4: "Hatukulazimishi kununua tokeni ili uwe na daftari. Kiwango kiko wazi; LOVE9 ni mafuta ya mtandao huu, si tiketi ya kuingia.",
    commit5: "Hatujengi AI yetu wenyewe. Tunabaki wasioegemea upande ili kila AI iweze kukuhudumia kwenye daftari lilelile.",
    joinTitle: "Miaka tisa huanza na watu wa kwanza",
    joinDesc: "Leo huu ni mtandao wa majaribio unaofanya kazi, wenye vithibitishaji vyake vya kwanza kutoka nje na minyororo yake ya kwanza ya jamii. Kila kilicho hapa chini kiko wazi, sasa hivi, kwa yeyote.",
    fullDoc: "Hati kamili",
  },
