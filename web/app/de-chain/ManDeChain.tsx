...
type TienTrinh = { dangChay: boolean; ten: string | null; buoc: MotBuoc[]; loi: string | null; uocConLaiGiay: number };

type Pha = 'vi' | 'nhap' | 'soat' | 'chay' | 'xong';
const TEN_HOP_LE = /^[A-Za-z0-9 ]{2,32}$/;

export function ManDeChain() {
  ...
  /* ── Vòng đọc tiến trình ──────────────────────────────────────────────────
     ...
     `/api/tien-trinh` cố ý rẻ — nó không chạm docker hay RPC, chỉ trả lại thứ đã
