# HANDOFF — LỊCH SỬ các đợt trước `2026-08-28`

> 🔴 **Tách khỏi `HANDOFF.md` ngày `2026-08-28` (A15-7).** Bản gốc dài **2.026 dòng /
> ~85K token**, và mỗi phiên mới phải đọc lại toàn bộ chỉ để tìm ~10% đang còn hiệu lực.
> Phần dưới đây **không mất một chữ nào** — nó chỉ thôi nằm trên đường đi hằng ngày.
>
> Đây là **bản ghi lịch sử**: mọi số đo, mọi ngày tháng, mọi "đã xong" ở dưới nói về **quá
> khứ**. Đừng sửa chúng cho khớp hiện tại — xem `CLAUDE.md` §2 về dấu miễn trừ.
>
> Đang còn hiệu lực: [`../../HANDOFF.md`](../../HANDOFF.md) · luật: [`../../CLAUDE.md`](../../CLAUDE.md)
...
# ⬇ Bổ sung `2026-08-28` (phiên khuya) — hai bảng "Đã xong" chuyển từ `HANDOFF.md`

> Chúng **kể về quá khứ** và đã được `DECISIONS.md` D-069…D-091b giữ đầy đủ lý do.
> Chuyển sang đây để `HANDOFF.md` về lại dưới trần 300 dòng (A15-7). Không mất một chữ nào.
